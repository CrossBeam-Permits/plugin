...
# Aliso Viejo — Pool Demolition Permit

Handles pool demolition permits in Aliso Viejo end-to-end.
...
```
## Ready to Submit — Aliso Viejo Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/aliso-viejo/pool-demolition/`.
