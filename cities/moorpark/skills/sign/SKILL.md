...
# Moorpark — Sign Permit

Handles sign permits in Moorpark end-to-end.
...
```
## Ready to Submit — Moorpark Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/moorpark/sign/`.
