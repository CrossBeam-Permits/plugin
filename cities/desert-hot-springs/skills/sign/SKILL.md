...
# Desert Hot Springs — Sign Permit

Handles sign permits in Desert Hot Springs end-to-end.
...
```
## Ready to Submit — Desert Hot Springs Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/desert-hot-springs/sign/`.
