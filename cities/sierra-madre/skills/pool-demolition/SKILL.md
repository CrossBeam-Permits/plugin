...
# Sierra Madre — Pool Demolition Permit

Handles pool demolition permits in Sierra Madre end-to-end.
...
```
## Ready to Submit — Sierra Madre Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/sierra-madre/pool-demolition/`.
