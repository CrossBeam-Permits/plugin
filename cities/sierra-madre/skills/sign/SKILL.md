...
# Sierra Madre — Sign Permit

Handles sign permits in Sierra Madre end-to-end.
...
```
## Ready to Submit — Sierra Madre Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/sierra-madre/sign/`.
