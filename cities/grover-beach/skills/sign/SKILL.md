...
# Grover Beach — Sign Permit

Handles sign permits in Grover Beach end-to-end.
...
```
## Ready to Submit — Grover Beach Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/grover-beach/sign/`.
