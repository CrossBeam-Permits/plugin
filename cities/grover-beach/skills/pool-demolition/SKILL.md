...
# Grover Beach — Pool Demolition Permit

Handles pool demolition permits in Grover Beach end-to-end.
...
```
## Ready to Submit — Grover Beach Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/grover-beach/pool-demolition/`.
