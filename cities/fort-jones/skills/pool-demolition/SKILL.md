...
# Town of Fort Jones — Pool Demolition Permit

Handles pool demolition permits in Town of Fort Jones end-to-end.
...
```
## Ready to Submit — Town of Fort Jones Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/fort-jones/pool-demolition/`.
