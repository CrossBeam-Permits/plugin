...
# Town of Fort Jones — Sign Permit

Handles sign permits in Town of Fort Jones end-to-end.
...
```
## Ready to Submit — Town of Fort Jones Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/fort-jones/sign/`.
