...
# Los Altos — Cleanout Permit

Handles cleanout permits in Los Altos end-to-end.
...
```
## Ready to Submit — Los Altos Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/los-altos/cleanout/`.
