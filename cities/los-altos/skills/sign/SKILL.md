...
# Los Altos — Sign Permit

Handles sign permits in Los Altos end-to-end.
...
```
## Ready to Submit — Los Altos Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/los-altos/sign/`.
