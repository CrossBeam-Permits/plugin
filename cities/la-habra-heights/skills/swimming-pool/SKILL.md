...
# La Habra Heights — Swimming Pool Permit

Handles swimming pool permits in La Habra Heights end-to-end.
...
```
## Ready to Submit — La Habra Heights Swimming Pool Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/swimming-pool/`. City overlay source: `skills/cities/la-habra-heights/swimming-pool/`.
