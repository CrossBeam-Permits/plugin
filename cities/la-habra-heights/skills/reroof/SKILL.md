...
# La Habra Heights — Reroof Permit

Handles reroof permits in La Habra Heights end-to-end.
...
```
## Ready to Submit — La Habra Heights Reroof Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/reroof/`. City overlay source: `skills/cities/la-habra-heights/reroof/`.
