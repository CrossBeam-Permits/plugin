...
# La Habra Heights — Sign Permit

Handles sign permits in La Habra Heights end-to-end.
...
```
## Ready to Submit — La Habra Heights Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/la-habra-heights/sign/`.
