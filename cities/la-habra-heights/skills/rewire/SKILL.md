...
# La Habra Heights — Rewire Permit

Handles rewire permits in La Habra Heights end-to-end.
...
```
## Ready to Submit — La Habra Heights Rewire Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/rewire/`. City overlay source: `skills/cities/la-habra-heights/rewire/`.
