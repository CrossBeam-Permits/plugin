...
# La Habra Heights — Cleanout Permit

Handles cleanout permits in La Habra Heights end-to-end.
...
```
## Ready to Submit — La Habra Heights Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/la-habra-heights/cleanout/`.
