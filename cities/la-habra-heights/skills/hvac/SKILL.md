...
# La Habra Heights — Hvac Permit

Handles hvac permits in La Habra Heights end-to-end.
...
```
## Ready to Submit — La Habra Heights Hvac Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/hvac/`. City overlay source: `skills/cities/la-habra-heights/hvac/`.
