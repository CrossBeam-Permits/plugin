...
# La Puente — Sign Permit

Handles sign permits in La Puente end-to-end.
...
```
## Ready to Submit — La Puente Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/la-puente/sign/`.
