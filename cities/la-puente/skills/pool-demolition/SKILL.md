...
# La Puente — Pool Demolition Permit

Handles pool demolition permits in La Puente end-to-end.
...
```
## Ready to Submit — La Puente Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/la-puente/pool-demolition/`.
