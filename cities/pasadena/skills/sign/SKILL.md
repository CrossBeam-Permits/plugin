...
# Pasadena — Sign Permit

Handles sign permits in Pasadena end-to-end.
...
```
## Ready to Submit — Pasadena Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/pasadena/sign/`.
