...
# San José — Pool Demolition Permit

Handles pool demolition permits in San José end-to-end.
...
```
## Ready to Submit — San José Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/san-jose/pool-demolition/`.
