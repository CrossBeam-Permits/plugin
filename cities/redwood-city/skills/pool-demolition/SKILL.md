...
# Redwood City — Pool Demolition Permit

Handles pool demolition permits in Redwood City end-to-end.
...
```
## Ready to Submit — Redwood City Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/redwood-city/pool-demolition/`.
