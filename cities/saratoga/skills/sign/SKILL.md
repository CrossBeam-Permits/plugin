...
# Saratoga — Sign Permit

Handles sign permits in Saratoga end-to-end.
...
```
## Ready to Submit — Saratoga Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/saratoga/sign/`.
