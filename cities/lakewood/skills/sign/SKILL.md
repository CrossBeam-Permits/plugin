...
# Lakewood — Sign Permit

Handles sign permits in Lakewood end-to-end.
...
```
## Ready to Submit — Lakewood Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/lakewood/sign/`.
