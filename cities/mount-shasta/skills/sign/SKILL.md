...
# Mount Shasta — Sign Permit

Handles sign permits in Mount Shasta end-to-end.
...
```
## Ready to Submit — Mount Shasta Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/mount-shasta/sign/`.
