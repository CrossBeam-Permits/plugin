...
# Monterey Park — Pool Demolition Permit

Handles pool demolition permits in Monterey Park end-to-end.
...
```
## Ready to Submit — Monterey Park Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/monterey-park/pool-demolition/`.
