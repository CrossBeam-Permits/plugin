...
# Monterey Park — Sign Permit

Handles sign permits in Monterey Park end-to-end.
...
```
## Ready to Submit — Monterey Park Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/monterey-park/sign/`.
