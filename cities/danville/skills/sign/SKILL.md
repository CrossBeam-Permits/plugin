...
# Danville — Sign Permit

Handles sign permits in Danville end-to-end.
...
```
## Ready to Submit — Danville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/danville/sign/`.
