...
# Commerce — Sign Permit

Handles sign permits in Commerce end-to-end.
...
```
## Ready to Submit — Commerce Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/commerce/sign/`.
