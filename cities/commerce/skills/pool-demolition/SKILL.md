...
# Commerce — Pool Demolition Permit

Handles pool demolition permits in Commerce end-to-end.
...
```
## Ready to Submit — Commerce Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/commerce/pool-demolition/`.
