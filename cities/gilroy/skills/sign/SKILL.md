...
Handles sign permits in Gilroy end-to-end.
...
```
## Ready to Submit — Gilroy Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/gilroy/sign/`.
