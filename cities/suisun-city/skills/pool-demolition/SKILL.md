...
# Suisun City — Pool Demolition Permit

Handles pool demolition permits in Suisun City end-to-end.
...
```
## Ready to Submit — Suisun City Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/suisun-city/pool-demolition/`.
