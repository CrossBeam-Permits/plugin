...
# Seaside — Pool Demolition Permit

Handles pool demolition permits in Seaside end-to-end.
...
```
## Ready to Submit — Seaside Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/seaside/pool-demolition/`.
