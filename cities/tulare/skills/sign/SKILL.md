...
Handles sign permits in Tulare end-to-end.
...
```
## Ready to Submit — Tulare Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/tulare/sign/`.
