...
# West Hollywood — Hvac Permit

Handles hvac permits in West Hollywood end-to-end.
...
```
## Ready to Submit — West Hollywood Hvac Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/hvac/`. City overlay source: `skills/cities/west-hollywood/hvac/`.
