...
# West Hollywood — Pool Demolition Permit

Handles pool demolition permits in West Hollywood end-to-end.
...
```
## Ready to Submit — West Hollywood Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/west-hollywood/pool-demolition/`.
