...
# West Hollywood — Sign Permit

Handles sign permits in West Hollywood end-to-end.
...
```
## Ready to Submit — West Hollywood Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/west-hollywood/sign/`.
