...
# Westminster — Sign Permit

Handles sign permits in Westminster end-to-end.
...
```
## Ready to Submit — Westminster Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/westminster/sign/`.
