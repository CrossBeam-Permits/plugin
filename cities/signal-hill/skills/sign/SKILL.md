...
# Signal Hill — Sign Permit

Handles sign permits in Signal Hill end-to-end.
...
```
## Ready to Submit — Signal Hill Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/signal-hill/sign/`.
