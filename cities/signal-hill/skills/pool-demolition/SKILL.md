...
# Signal Hill — Pool Demolition Permit

Handles pool demolition permits in Signal Hill end-to-end.
...
```
## Ready to Submit — Signal Hill Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/signal-hill/pool-demolition/`.
