...
Handles sign permits in Carson end-to-end.
...
```
## Ready to Submit — Carson Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/carson/sign/`.
