...
# Canyon Lake — Pool Demolition Permit

Handles pool demolition permits in Canyon Lake end-to-end.
...
```
## Ready to Submit — Canyon Lake Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/canyon-lake/pool-demolition/`.
