...
# Canyon Lake — Sign Permit

Handles sign permits in Canyon Lake end-to-end.
...
```
## Ready to Submit — Canyon Lake Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/canyon-lake/sign/`.
