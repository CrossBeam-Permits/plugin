...
# Orange Cove — Pool Demolition Permit

Handles pool demolition permits in Orange Cove end-to-end.
...
```
## Ready to Submit — Orange Cove Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/orange-cove/pool-demolition/`.
