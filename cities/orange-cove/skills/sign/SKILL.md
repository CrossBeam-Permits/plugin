...
# Orange Cove — Sign Permit

Handles sign permits in Orange Cove end-to-end.
...
```
## Ready to Submit — Orange Cove Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/orange-cove/sign/`.
