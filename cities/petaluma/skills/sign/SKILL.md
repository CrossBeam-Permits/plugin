...
# Petaluma — Sign Permit

Handles sign permits in Petaluma end-to-end.
...
```
## Ready to Submit — Petaluma Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/petaluma/sign/`.
