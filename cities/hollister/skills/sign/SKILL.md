...
# Hollister — Sign Permit

Handles sign permits in Hollister end-to-end.
...
```
## Ready to Submit — Hollister Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/hollister/sign/`.
