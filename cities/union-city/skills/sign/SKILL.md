...
# Union City — Sign Permit

Handles sign permits in Union City end-to-end.
...
```
## Ready to Submit — Union City Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/union-city/sign/`.
