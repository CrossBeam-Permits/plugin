...
# Red Bluff — Pool Demolition Permit

Handles pool demolition permits in Red Bluff end-to-end.
...
```
## Ready to Submit — Red Bluff Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/red-bluff/pool-demolition/`.
