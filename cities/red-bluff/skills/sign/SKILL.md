...
# Red Bluff — Sign Permit

Handles sign permits in Red Bluff end-to-end.
...
```
## Ready to Submit — Red Bluff Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/red-bluff/sign/`.
