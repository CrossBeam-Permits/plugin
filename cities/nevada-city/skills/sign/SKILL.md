...
# Nevada City — Sign Permit

Handles sign permits in Nevada City end-to-end.
...
```
## Ready to Submit — Nevada City Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/nevada-city/sign/`.
