...
# Guadalupe — Sign Permit

Handles sign permits in Guadalupe end-to-end.
...
```
## Ready to Submit — Guadalupe Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/guadalupe/sign/`.
