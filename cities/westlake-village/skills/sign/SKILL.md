...
# Westlake Village — Sign Permit

Handles sign permits in Westlake Village end-to-end.
...
```
## Ready to Submit — Westlake Village Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/westlake-village/sign/`.
