...
# Westlake Village — Pool Demolition Permit

Handles pool demolition permits in Westlake Village end-to-end.
...
```
## Ready to Submit — Westlake Village Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/westlake-village/pool-demolition/`.
