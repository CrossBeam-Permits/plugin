...
# City of Colusa — Pool Demolition Permit

Handles pool demolition permits in City of Colusa end-to-end.
...
```
## Ready to Submit — City of Colusa Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/colusa/pool-demolition/`.
