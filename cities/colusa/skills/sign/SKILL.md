...
# City of Colusa — Sign Permit

Handles sign permits in City of Colusa end-to-end.
...
```
## Ready to Submit — City of Colusa Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/colusa/sign/`.
