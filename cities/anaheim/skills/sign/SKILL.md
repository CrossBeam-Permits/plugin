...
Handles sign permits in Anaheim end-to-end.
...
```
## Ready to Submit — Anaheim Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/anaheim/sign/`.
