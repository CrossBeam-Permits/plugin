...
# Larkspur — Pool Demolition Permit

Handles pool demolition permits in Larkspur end-to-end.
...
```
## Ready to Submit — Larkspur Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/larkspur/pool-demolition/`.
