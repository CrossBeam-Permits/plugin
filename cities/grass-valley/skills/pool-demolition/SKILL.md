...
# Grass Valley — Pool Demolition Permit

Handles pool demolition permits in Grass Valley end-to-end.
...
```
## Ready to Submit — Grass Valley Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/grass-valley/pool-demolition/`.
