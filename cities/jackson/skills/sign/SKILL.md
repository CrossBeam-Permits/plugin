...
Handles sign permits in Jackson end-to-end.
...
```
## Ready to Submit — Jackson Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/jackson/sign/`.
