...
# Capitola — Sign Permit

Handles sign permits in Capitola end-to-end.
...
```
## Ready to Submit — Capitola Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/capitola/sign/`.
