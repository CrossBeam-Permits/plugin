...
# City of Tehama — Sign Permit

Handles sign permits in City of Tehama end-to-end.
...
```
## Ready to Submit — City of Tehama Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/tehama/sign/`.
