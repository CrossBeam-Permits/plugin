...
# Alhambra — Sign Permit

Handles sign permits in Alhambra end-to-end.
...
```
## Ready to Submit — Alhambra Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/alhambra/sign/`.
