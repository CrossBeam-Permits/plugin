...
# Santa Fe Springs — Sign Permit

Handles sign permits in Santa Fe Springs end-to-end.
...
```
## Ready to Submit — Santa Fe Springs Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/santa-fe-springs/sign/`.
