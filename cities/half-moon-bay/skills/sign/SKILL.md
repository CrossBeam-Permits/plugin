...
# Half Moon Bay — Sign Permit

Handles sign permits in Half Moon Bay end-to-end.
...
```
## Ready to Submit — Half Moon Bay Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/half-moon-bay/sign/`.
