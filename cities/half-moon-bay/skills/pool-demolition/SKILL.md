...
# Half Moon Bay — Pool Demolition Permit

Handles pool demolition permits in Half Moon Bay end-to-end.
...
```
## Ready to Submit — Half Moon Bay Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/half-moon-bay/pool-demolition/`.
