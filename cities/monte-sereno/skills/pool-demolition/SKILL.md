...
# Monte Sereno — Pool Demolition Permit

Handles pool demolition permits in Monte Sereno end-to-end.
...
```
## Ready to Submit — Monte Sereno Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/monte-sereno/pool-demolition/`.
