...
# Monte Sereno — Sign Permit

Handles sign permits in Monte Sereno end-to-end.
...
```
## Ready to Submit — Monte Sereno Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/monte-sereno/sign/`.
