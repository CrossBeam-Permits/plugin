...
# City of Rio Dell — Cleanout Permit

Handles cleanout permits in City of Rio Dell end-to-end.
...
```
## Ready to Submit — City of Rio Dell Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/rio-dell/cleanout/`.
