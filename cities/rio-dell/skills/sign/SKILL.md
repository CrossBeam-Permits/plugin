...
# City of Rio Dell — Sign Permit

Handles sign permits in City of Rio Dell end-to-end.
...
```
## Ready to Submit — City of Rio Dell Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/rio-dell/sign/`.
