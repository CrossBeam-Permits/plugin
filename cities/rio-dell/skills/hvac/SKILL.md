...
# City of Rio Dell — Hvac Permit

Handles hvac permits in City of Rio Dell end-to-end.
...
```
## Ready to Submit — City of Rio Dell Hvac Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/hvac/`. City overlay source: `skills/cities/rio-dell/hvac/`.
