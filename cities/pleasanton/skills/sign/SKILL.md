...
# Pleasanton — Sign Permit

Handles sign permits in Pleasanton end-to-end.
...
```
## Ready to Submit — Pleasanton Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/pleasanton/sign/`.
