...
# Los Alamitos — Ev Charger Permit

Handles ev charger permits in Los Alamitos end-to-end.
...
```
## Ready to Submit — Los Alamitos Ev Charger Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ev-charger/`. City overlay source: `skills/cities/los-alamitos/ev-charger/`.
