...
# Camarillo — Hvac Permit

Handles hvac permits in Camarillo end-to-end.
...
```
## Ready to Submit — Camarillo Hvac Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/hvac/`. City overlay source: `skills/cities/camarillo/hvac/`.
