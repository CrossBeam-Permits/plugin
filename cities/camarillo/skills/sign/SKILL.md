...
# Camarillo — Sign Permit

Handles sign permits in Camarillo end-to-end.
...
```
## Ready to Submit — Camarillo Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/camarillo/sign/`.
