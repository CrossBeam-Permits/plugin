...
Handles sign permits in Artesia end-to-end.
...
```
## Ready to Submit — Artesia Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/artesia/sign/`.
