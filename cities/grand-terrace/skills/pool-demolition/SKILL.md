...
# Grand Terrace — Pool Demolition Permit

Handles pool demolition permits in Grand Terrace end-to-end.
...
```
## Ready to Submit — Grand Terrace Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/grand-terrace/pool-demolition/`.
