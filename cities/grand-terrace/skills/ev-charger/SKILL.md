...
# Grand Terrace — Ev Charger Permit

Handles ev charger permits in Grand Terrace end-to-end.
...
```
## Ready to Submit — Grand Terrace Ev Charger Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ev-charger/`. City overlay source: `skills/cities/grand-terrace/ev-charger/`.
