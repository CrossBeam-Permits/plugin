...
# Grand Terrace — Sign Permit

Handles sign permits in Grand Terrace end-to-end.
...
```
## Ready to Submit — Grand Terrace Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/grand-terrace/sign/`.
