...
# Emeryville — Sign Permit

Handles sign permits in Emeryville end-to-end.
...
```
## Ready to Submit — Emeryville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/emeryville/sign/`.
