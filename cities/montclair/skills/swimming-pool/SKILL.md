...
# Montclair — Swimming Pool Permit

Handles swimming pool permits in Montclair end-to-end.
...
```
## Ready to Submit — Montclair Swimming Pool Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/swimming-pool/`. City overlay source: `skills/cities/montclair/swimming-pool/`.
