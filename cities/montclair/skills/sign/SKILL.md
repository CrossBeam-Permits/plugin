...
# Montclair — Sign Permit

Handles sign permits in Montclair end-to-end.
...
```
## Ready to Submit — Montclair Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/montclair/sign/`.
