...
# Huntington Beach — Sign Permit

Handles sign permits in Huntington Beach end-to-end.
...
```
## Ready to Submit — Huntington Beach Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/huntington-beach/sign/`.
