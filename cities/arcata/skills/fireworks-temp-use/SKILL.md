...
# Arcata — Fireworks Temp Use Permit

Handles fireworks temp use permits in Arcata end-to-end.
...
```
## Ready to Submit — Arcata Fireworks Temp Use Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/fireworks-temp-use/`. City overlay source: `skills/cities/arcata/fireworks-temp-use/`.
