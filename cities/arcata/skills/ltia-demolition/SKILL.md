...
# Arcata — Ltia Demolition Permit

Handles ltia demolition permits in Arcata end-to-end.
...
```
## Ready to Submit — Arcata Ltia Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ltia-demolition/`. City overlay source: `skills/cities/arcata/ltia-demolition/`.
