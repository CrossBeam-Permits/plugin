...
# Placentia — Sign Permit

Handles sign permits in Placentia end-to-end.
...
```
## Ready to Submit — Placentia Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/placentia/sign/`.
