...
Handles sign permits in Exeter end-to-end.
...
```
## Ready to Submit — Exeter Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/exeter/sign/`.
