...
# Lakeport — Rewire Permit

Handles rewire permits in Lakeport end-to-end.
...
```
## Ready to Submit — Lakeport Rewire Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/rewire/`. City overlay source: `skills/cities/lakeport/rewire/`.
