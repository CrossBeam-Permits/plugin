...
# Lakeport — Sign Permit

Handles sign permits in Lakeport end-to-end.
...
```
## Ready to Submit — Lakeport Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/lakeport/sign/`.
