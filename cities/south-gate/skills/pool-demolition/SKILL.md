...
# South Gate — Pool Demolition Permit

Handles pool demolition permits in South Gate end-to-end.
...
```
## Ready to Submit — South Gate Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/south-gate/pool-demolition/`.
