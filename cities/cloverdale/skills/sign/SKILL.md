...
# Cloverdale — Sign Permit

Handles sign permits in Cloverdale end-to-end.
...
```
## Ready to Submit — Cloverdale Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/cloverdale/sign/`.
