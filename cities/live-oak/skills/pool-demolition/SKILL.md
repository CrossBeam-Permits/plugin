...
# Live Oak — Pool Demolition Permit

Handles pool demolition permits in Live Oak end-to-end.
...
```
## Ready to Submit — Live Oak Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/live-oak/pool-demolition/`.
