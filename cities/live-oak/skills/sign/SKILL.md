...
# Live Oak — Sign Permit

Handles sign permits in Live Oak end-to-end.
...
```
## Ready to Submit — Live Oak Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/live-oak/sign/`.
