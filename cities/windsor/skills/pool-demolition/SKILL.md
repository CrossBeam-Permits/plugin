...
# Windsor — Pool Demolition Permit

Handles pool demolition permits in Windsor end-to-end.
...
```
## Ready to Submit — Windsor Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/windsor/pool-demolition/`.
