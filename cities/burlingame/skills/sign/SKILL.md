...
# Burlingame — Sign Permit

Handles sign permits in Burlingame end-to-end.
...
```
## Ready to Submit — Burlingame Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/burlingame/sign/`.
