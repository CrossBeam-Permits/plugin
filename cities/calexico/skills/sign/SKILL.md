...
# Calexico — Sign Permit

Handles sign permits in Calexico end-to-end.
...
```
## Ready to Submit — Calexico Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/calexico/sign/`.
