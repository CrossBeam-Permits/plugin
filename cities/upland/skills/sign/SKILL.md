...
Handles sign permits in Upland end-to-end.
...
```
## Ready to Submit — Upland Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/upland/sign/`.
