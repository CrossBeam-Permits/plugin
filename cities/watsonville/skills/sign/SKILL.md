...
# Watsonville — Sign Permit

Handles sign permits in Watsonville end-to-end.
...
```
## Ready to Submit — Watsonville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/watsonville/sign/`.
