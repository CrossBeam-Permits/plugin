...
# Dos Palos — Sign Permit

Handles sign permits in Dos Palos end-to-end.
...
```
## Ready to Submit — Dos Palos Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/dos-palos/sign/`.
