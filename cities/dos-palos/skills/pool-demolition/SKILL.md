...
# Dos Palos — Pool Demolition Permit

Handles pool demolition permits in Dos Palos end-to-end.
...
```
## Ready to Submit — Dos Palos Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/dos-palos/pool-demolition/`.
