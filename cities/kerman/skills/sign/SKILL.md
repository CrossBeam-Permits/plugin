...
Handles sign permits in Kerman end-to-end.
...
```
## Ready to Submit — Kerman Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/kerman/sign/`.
