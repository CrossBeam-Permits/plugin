...
# Placerville — Sign Permit

Handles sign permits in Placerville end-to-end.
...
```
## Ready to Submit — Placerville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/placerville/sign/`.
