...
# Bakersfield — Sign Permit

Handles sign permits in Bakersfield end-to-end.
...
```
## Ready to Submit — Bakersfield Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/bakersfield/sign/`.
