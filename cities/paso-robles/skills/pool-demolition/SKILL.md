...
# Paso Robles — Pool Demolition Permit

Handles pool demolition permits in Paso Robles end-to-end.
...
```
## Ready to Submit — Paso Robles Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/paso-robles/pool-demolition/`.
