...
# Paso Robles — Sign Permit

Handles sign permits in Paso Robles end-to-end.
...
```
## Ready to Submit — Paso Robles Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/paso-robles/sign/`.
