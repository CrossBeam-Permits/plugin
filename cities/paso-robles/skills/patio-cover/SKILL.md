...
# Paso Robles — Patio Cover Permit

Handles patio cover permits in Paso Robles end-to-end.
...
```
## Ready to Submit — Paso Robles Patio Cover Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/patio-cover/`. City overlay source: `skills/cities/paso-robles/patio-cover/`.
