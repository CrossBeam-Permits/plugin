...
Handles sign permits in Truckee end-to-end.
...
```
## Ready to Submit — Truckee Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/truckee/sign/`.
