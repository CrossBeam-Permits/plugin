...
# Seal Beach — Sign Permit

Handles sign permits in Seal Beach end-to-end.
...
```
## Ready to Submit — Seal Beach Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/seal-beach/sign/`.
