...
# Rohnert Park — Pool Demolition Permit

Handles pool demolition permits in Rohnert Park end-to-end.
...
```
## Ready to Submit — Rohnert Park Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/rohnert-park/pool-demolition/`.
