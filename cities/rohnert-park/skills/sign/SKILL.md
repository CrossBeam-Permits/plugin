...
# Rohnert Park — Sign Permit

Handles sign permits in Rohnert Park end-to-end.
...
```
## Ready to Submit — Rohnert Park Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/rohnert-park/sign/`.
