...
# Beverly Hills — Sign Permit

Handles sign permits in Beverly Hills end-to-end.
...
```
## Ready to Submit — Beverly Hills Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/beverly-hills/sign/`.
