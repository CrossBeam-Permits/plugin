...
Handles sign permits in Benicia end-to-end.
...
```
## Ready to Submit — Benicia Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/benicia/sign/`.
