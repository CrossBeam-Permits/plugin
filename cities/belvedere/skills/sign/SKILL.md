...
# Belvedere — Sign Permit

Handles sign permits in Belvedere end-to-end.
...
```
## Ready to Submit — Belvedere Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/belvedere/sign/`.
