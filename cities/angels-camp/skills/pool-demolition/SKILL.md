...
# City of Angels Camp — Pool Demolition Permit

Handles pool demolition permits in City of Angels Camp end-to-end.
...
```
## Ready to Submit — City of Angels Camp Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/angels-camp/pool-demolition/`.
