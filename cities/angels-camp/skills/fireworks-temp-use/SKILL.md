...
# City of Angels Camp — Fireworks Temp Use Permit

Handles fireworks temp use permits in City of Angels Camp end-to-end.
...
```
## Ready to Submit — City of Angels Camp Fireworks Temp Use Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/fireworks-temp-use/`. City overlay source: `skills/cities/angels-camp/fireworks-temp-use/`.
