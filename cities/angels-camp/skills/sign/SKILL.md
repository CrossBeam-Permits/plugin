...
# City of Angels Camp — Sign Permit

Handles sign permits in City of Angels Camp end-to-end.
...
```
## Ready to Submit — City of Angels Camp Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/angels-camp/sign/`.
