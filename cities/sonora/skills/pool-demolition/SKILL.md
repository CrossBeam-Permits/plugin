...
# City of Sonora — Pool Demolition Permit

Handles pool demolition permits in City of Sonora end-to-end.
...
```
## Ready to Submit — City of Sonora Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/sonora/pool-demolition/`.
