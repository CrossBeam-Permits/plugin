...
# Ontario — Pool Demolition Permit

Handles pool demolition permits in Ontario end-to-end.
...
```
## Ready to Submit — Ontario Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/ontario/pool-demolition/`.
