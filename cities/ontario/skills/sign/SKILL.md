...
Handles sign permits in Ontario end-to-end.
...
```
## Ready to Submit — Ontario Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/ontario/sign/`.
