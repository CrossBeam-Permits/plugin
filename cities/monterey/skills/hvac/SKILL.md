...
# Monterey — Hvac Permit

Handles hvac permits in Monterey end-to-end.
...
```
## Ready to Submit — Monterey Hvac Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/hvac/`. City overlay source: `skills/cities/monterey/hvac/`.
