...
# Monterey — Swimming Pool Permit

Handles swimming pool permits in Monterey end-to-end.
...
```
## Ready to Submit — Monterey Swimming Pool Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/swimming-pool/`. City overlay source: `skills/cities/monterey/swimming-pool/`.
