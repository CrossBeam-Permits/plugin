...
# Monterey — Pool Demolition Permit

Handles pool demolition permits in Monterey end-to-end.
...
```
## Ready to Submit — Monterey Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/monterey/pool-demolition/`.
