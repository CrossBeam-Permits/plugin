...
# Monterey — Rewire Permit

Handles rewire permits in Monterey end-to-end.
...
```
## Ready to Submit — Monterey Rewire Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/rewire/`. City overlay source: `skills/cities/monterey/rewire/`.
