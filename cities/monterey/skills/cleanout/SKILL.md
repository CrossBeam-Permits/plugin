...
# Monterey — Cleanout Permit

Handles cleanout permits in Monterey end-to-end.
...
```
## Ready to Submit — Monterey Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/monterey/cleanout/`.
