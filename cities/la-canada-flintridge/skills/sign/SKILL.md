...
# La Canada Flintridge — Sign Permit

Handles sign permits in La Canada Flintridge end-to-end.
...
```
## Ready to Submit — La Canada Flintridge Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/la-canada-flintridge/sign/`.
