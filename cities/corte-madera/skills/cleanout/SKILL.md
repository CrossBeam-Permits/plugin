...
# Corte Madera — Cleanout Permit

Handles cleanout permits in Corte Madera end-to-end.
...
```
## Ready to Submit — Corte Madera Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/corte-madera/cleanout/`.
