...
# Corte Madera — Sign Permit

Handles sign permits in Corte Madera end-to-end.
...
```
## Ready to Submit — Corte Madera Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/corte-madera/sign/`.
