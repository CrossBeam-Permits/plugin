...
# Corte Madera — Pool Demolition Permit

Handles pool demolition permits in Corte Madera end-to-end.
...
```
## Ready to Submit — Corte Madera Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/corte-madera/pool-demolition/`.
