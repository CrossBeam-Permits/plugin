...
# Hercules — Sign Permit

Handles sign permits in Hercules end-to-end.
...
```
## Ready to Submit — Hercules Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/hercules/sign/`.
