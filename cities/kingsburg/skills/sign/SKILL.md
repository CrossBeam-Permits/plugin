...
# Kingsburg — Sign Permit

Handles sign permits in Kingsburg end-to-end.
...
```
## Ready to Submit — Kingsburg Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/kingsburg/sign/`.
