...
# Pismo Beach — Sign Permit

Handles sign permits in Pismo Beach end-to-end.
...
```
## Ready to Submit — Pismo Beach Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/pismo-beach/sign/`.
