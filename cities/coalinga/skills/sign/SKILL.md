...
# Coalinga — Sign Permit

Handles sign permits in Coalinga end-to-end.
...
```
## Ready to Submit — Coalinga Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/coalinga/sign/`.
