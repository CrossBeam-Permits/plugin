...
# Fillmore — Sign Permit

Handles sign permits in Fillmore end-to-end.
...
```
## Ready to Submit — Fillmore Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/fillmore/sign/`.
