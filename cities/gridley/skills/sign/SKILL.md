...
Handles sign permits in Gridley end-to-end.
...
```
## Ready to Submit — Gridley Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/gridley/sign/`.
