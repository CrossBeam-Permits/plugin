...
# Jurupa Valley — Pool Demolition Permit

Handles pool demolition permits in Jurupa Valley end-to-end.
...
```
## Ready to Submit — Jurupa Valley Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/jurupa-valley/pool-demolition/`.
