...
# Pinole — Pool Demolition Permit

Handles pool demolition permits in Pinole end-to-end.
...
```
## Ready to Submit — Pinole Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/pinole/pool-demolition/`.
