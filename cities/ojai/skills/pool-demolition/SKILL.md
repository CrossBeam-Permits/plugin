...
# Ojai — Pool Demolition Permit

Handles pool demolition permits in Ojai end-to-end.
...
```
## Ready to Submit — Ojai Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/ojai/pool-demolition/`.
