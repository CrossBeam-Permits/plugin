...
# Cathedral City — Sign Permit

Handles sign permits in Cathedral City end-to-end.
...
```
## Ready to Submit — Cathedral City Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/cathedral-city/sign/`.
