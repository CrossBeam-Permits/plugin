...
# Pacific Grove — Sign Permit

Handles sign permits in Pacific Grove end-to-end.
...
```
## Ready to Submit — Pacific Grove Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/pacific-grove/sign/`.
