...
# Citrus Heights — Sign Permit

Handles sign permits in Citrus Heights end-to-end.
...
```
## Ready to Submit — Citrus Heights Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/citrus-heights/sign/`.
