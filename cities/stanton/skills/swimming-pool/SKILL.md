---
description: "Swimming Pool permits in Stanton, CA. Works in two modes: (A) BUILDER/HOMEOWNER — walks through project scoping, checks compliance against state code + Stanton local amendments, produces a portal-ready submission guide; (B) CITY REVIEWER — runs the plan-check checklist against a submittal and produces tight corrections output. Inspection items deferred (not listed as corrections). Use when the user mentions swimming pool in Stanton."
version: "1.0"
...
# Stanton — Swimming Pool Permit

Handles swimming pool permits in Stanton end-to-end.
...
- **1** City Swimming Pool Checklist — **flag**
- **2** Swimming Pool Spa Demo document — **flag**
- **3** Plan review required — **flag**
- **4** Fences, Walls, and Hedges — **flag**
...
```
## Ready to Submit — Stanton Swimming Pool Permit
...
| 1 | **City Swimming Pool Checklist** `[SMC]` | ⚠️ **flag** | Stanton publishes a "Swimming Pool Checklist" — use for submittal completeness verification | stantonca.gov applications page |
| 2 | **Swimming Pool Spa Demo document** `[SMC]` | ⚠️ **flag** | Additional "Swimming Pool Spa Demo" document available for demolition/removal projects | stantonca.gov applications page |
| 3 | **Plan review required** `[SMC]` | ⚠️ **flag** | Swimming pool/spa installations require full plan review — submit via stanton.cts.city | Building Division |
| 4 | **Fences, Walls, and Hedges** `[SMC]` | ⚠️ **flag** | Pool enclosure fence requirements governed by Ch. 20.345 in addition to state law | § 20.345 |
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/swimming-pool/`. City overlay source: `skills/cities/stanton/swimming-pool/`.
