...
Handles sign permits in Stanton end-to-end.
...
```
## Ready to Submit — Stanton Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/stanton/sign/`.
