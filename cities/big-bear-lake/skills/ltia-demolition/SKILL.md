...
# Big Bear Lake — Ltia Demolition Permit

Handles ltia demolition permits in Big Bear Lake end-to-end.
...
```
## Ready to Submit — Big Bear Lake Ltia Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ltia-demolition/`. City overlay source: `skills/cities/big-bear-lake/ltia-demolition/`.
