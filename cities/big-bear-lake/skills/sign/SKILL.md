...
# Big Bear Lake — Sign Permit

Handles sign permits in Big Bear Lake end-to-end.
...
```
## Ready to Submit — Big Bear Lake Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/big-bear-lake/sign/`.
