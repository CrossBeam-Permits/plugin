...
# Pico Rivera — Pool Demolition Permit

Handles pool demolition permits in Pico Rivera end-to-end.
...
```
## Ready to Submit — Pico Rivera Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/pico-rivera/pool-demolition/`.
