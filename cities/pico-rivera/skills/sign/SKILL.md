...
# Pico Rivera — Sign Permit

Handles sign permits in Pico Rivera end-to-end.
...
```
## Ready to Submit — Pico Rivera Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/pico-rivera/sign/`.
