...
# Loma Linda — Sign Permit

Handles sign permits in Loma Linda end-to-end.
...
```
## Ready to Submit — Loma Linda Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/loma-linda/sign/`.
