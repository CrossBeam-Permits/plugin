...
# Loma Linda — Pool Demolition Permit

Handles pool demolition permits in Loma Linda end-to-end.
...
```
## Ready to Submit — Loma Linda Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/loma-linda/pool-demolition/`.
