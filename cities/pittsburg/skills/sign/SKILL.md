...
# Pittsburg — Sign Permit

Handles sign permits in Pittsburg end-to-end.
...
```
## Ready to Submit — Pittsburg Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/pittsburg/sign/`.
