...
Handles sign permits in Salinas end-to-end.
...
```
## Ready to Submit — Salinas Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/salinas/sign/`.
