...
# Long Beach — Pool Demolition Permit

Handles pool demolition permits in Long Beach end-to-end.
...
```
## Ready to Submit — Long Beach Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/long-beach/pool-demolition/`.
