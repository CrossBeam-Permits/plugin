...
# Long Beach — Sign Permit

Handles sign permits in Long Beach end-to-end.
...
```
## Ready to Submit — Long Beach Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/long-beach/sign/`.
