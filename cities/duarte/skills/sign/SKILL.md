...
Handles sign permits in Duarte end-to-end.
...
```
## Ready to Submit — Duarte Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/duarte/sign/`.
