...
# Concord — Pool Demolition Permit

Handles pool demolition permits in Concord end-to-end.
...
```
## Ready to Submit — Concord Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/concord/pool-demolition/`.
