...
# Blythe — Pool Demolition Permit

Handles pool demolition permits in Blythe end-to-end.
...
```
## Ready to Submit — Blythe Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/blythe/pool-demolition/`.
