...
Handles sign permits in Blythe end-to-end.
...
```
## Ready to Submit — Blythe Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/blythe/sign/`.
