...
Handles sign permits in Portola end-to-end.
...
```
## Ready to Submit — Portola Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/portola/sign/`.
