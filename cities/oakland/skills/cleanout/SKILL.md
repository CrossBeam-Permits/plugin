...
# Oakland — Cleanout Permit

Handles cleanout permits in Oakland end-to-end.
...
```
## Ready to Submit — Oakland Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/oakland/cleanout/`.
