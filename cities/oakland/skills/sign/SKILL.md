...
Handles sign permits in Oakland end-to-end.
...
```
## Ready to Submit — Oakland Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/oakland/sign/`.
