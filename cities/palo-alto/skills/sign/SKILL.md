...
# Palo Alto — Sign Permit

Handles sign permits in Palo Alto end-to-end.
...
```
## Ready to Submit — Palo Alto Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/palo-alto/sign/`.
