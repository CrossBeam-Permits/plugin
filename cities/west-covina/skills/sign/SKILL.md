...
# West Covina — Sign Permit

Handles sign permits in West Covina end-to-end.
...
```
## Ready to Submit — West Covina Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/west-covina/sign/`.
