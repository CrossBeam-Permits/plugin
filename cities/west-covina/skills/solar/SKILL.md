...
# West Covina — Solar Permit

Handles solar permits in West Covina end-to-end.
...
```
## Ready to Submit — West Covina Solar Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/solar/`. City overlay source: `skills/cities/west-covina/solar/`.
