...
# West Covina — Pool Demolition Permit

Handles pool demolition permits in West Covina end-to-end.
...
```
## Ready to Submit — West Covina Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/west-covina/pool-demolition/`.
