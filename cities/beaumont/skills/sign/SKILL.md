...
# Beaumont — Sign Permit

Handles sign permits in Beaumont end-to-end.
...
```
## Ready to Submit — Beaumont Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/beaumont/sign/`.
