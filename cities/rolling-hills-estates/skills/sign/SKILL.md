...
# Rolling Hills Estates — Sign Permit

Handles sign permits in Rolling Hills Estates end-to-end.
...
```
## Ready to Submit — Rolling Hills Estates Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/rolling-hills-estates/sign/`.
