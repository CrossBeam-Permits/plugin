...
# Huntington Park — Pool Demolition Permit

Handles pool demolition permits in Huntington Park end-to-end.
...
```
## Ready to Submit — Huntington Park Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/huntington-park/pool-demolition/`.
