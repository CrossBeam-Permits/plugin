...
# Laguna Niguel — Sign Permit

Handles sign permits in Laguna Niguel end-to-end.
...
```
## Ready to Submit — Laguna Niguel Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/laguna-niguel/sign/`.
