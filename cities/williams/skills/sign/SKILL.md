...
# Williams — Sign Permit

Handles sign permits in Williams end-to-end.
...
```
## Ready to Submit — Williams Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/williams/sign/`.
