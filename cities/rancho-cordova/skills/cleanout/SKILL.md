...
# Rancho Cordova — Cleanout Permit

Handles cleanout permits in Rancho Cordova end-to-end.
...
```
## Ready to Submit — Rancho Cordova Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/rancho-cordova/cleanout/`.
