...
# Rancho Cordova — Swimming Pool Permit

Handles swimming pool permits in Rancho Cordova end-to-end.
...
```
## Ready to Submit — Rancho Cordova Swimming Pool Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/swimming-pool/`. City overlay source: `skills/cities/rancho-cordova/swimming-pool/`.
