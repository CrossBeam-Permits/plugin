...
# Rancho Cordova — Pool Demolition Permit

Handles pool demolition permits in Rancho Cordova end-to-end.
...
```
## Ready to Submit — Rancho Cordova Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/rancho-cordova/pool-demolition/`.
