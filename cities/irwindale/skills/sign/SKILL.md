...
# Irwindale — Sign Permit

Handles sign permits in Irwindale end-to-end.
...
```
## Ready to Submit — Irwindale Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/irwindale/sign/`.
