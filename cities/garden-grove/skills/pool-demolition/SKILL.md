...
# Garden Grove — Pool Demolition Permit

Handles pool demolition permits in Garden Grove end-to-end.
...
```
## Ready to Submit — Garden Grove Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/garden-grove/pool-demolition/`.
