...
# Bradbury — Sign Permit

Handles sign permits in Bradbury end-to-end.
...
```
## Ready to Submit — Bradbury Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/bradbury/sign/`.
