...
# Morgan Hill — Patio Cover Permit

Handles patio cover permits in Morgan Hill end-to-end.
...
```
## Ready to Submit — Morgan Hill Patio Cover Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/patio-cover/`. City overlay source: `skills/cities/morgan-hill/patio-cover/`.
