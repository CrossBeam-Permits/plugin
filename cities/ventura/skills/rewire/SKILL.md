...
# Ventura — Rewire Permit

Handles rewire permits in Ventura end-to-end.
...
```
## Ready to Submit — Ventura Rewire Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/rewire/`. City overlay source: `skills/cities/ventura/rewire/`.
