...
# Newman — Pool Demolition Permit

Handles pool demolition permits in Newman end-to-end.
...
```
## Ready to Submit — Newman Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/newman/pool-demolition/`.
