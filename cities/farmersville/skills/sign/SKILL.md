...
# Farmersville — Sign Permit

Handles sign permits in Farmersville end-to-end.
...
```
## Ready to Submit — Farmersville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/farmersville/sign/`.
