...
# Imperial Beach — Sign Permit

Handles sign permits in Imperial Beach end-to-end.
...
```
## Ready to Submit — Imperial Beach Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/imperial-beach/sign/`.
