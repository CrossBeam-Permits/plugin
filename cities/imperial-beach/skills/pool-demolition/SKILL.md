...
# Imperial Beach — Pool Demolition Permit

Handles pool demolition permits in Imperial Beach end-to-end.
...
```
## Ready to Submit — Imperial Beach Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/imperial-beach/pool-demolition/`.
