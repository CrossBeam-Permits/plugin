...
# El Cajon — Pool Demolition Permit

Handles pool demolition permits in El Cajon end-to-end.
...
```
## Ready to Submit — El Cajon Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/el-cajon/pool-demolition/`.
