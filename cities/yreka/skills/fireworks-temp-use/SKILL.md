...
# Yreka — Fireworks Temp Use Permit

Handles fireworks temp use permits in Yreka end-to-end.
...
```
## Ready to Submit — Yreka Fireworks Temp Use Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/fireworks-temp-use/`. City overlay source: `skills/cities/yreka/fireworks-temp-use/`.
