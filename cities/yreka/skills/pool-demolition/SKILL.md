...
# Yreka — Pool Demolition Permit

Handles pool demolition permits in Yreka end-to-end.
...
```
## Ready to Submit — Yreka Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/yreka/pool-demolition/`.
