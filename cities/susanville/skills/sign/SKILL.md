...
# Susanville — Sign Permit

Handles sign permits in Susanville end-to-end.
...
```
## Ready to Submit — Susanville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/susanville/sign/`.
