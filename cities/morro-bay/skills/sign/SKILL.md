...
# Morro Bay — Sign Permit

Handles sign permits in Morro Bay end-to-end.
...
```
## Ready to Submit — Morro Bay Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/morro-bay/sign/`.
