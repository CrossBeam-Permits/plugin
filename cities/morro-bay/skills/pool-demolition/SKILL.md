...
# Morro Bay — Pool Demolition Permit

Handles pool demolition permits in Morro Bay end-to-end.
...
```
## Ready to Submit — Morro Bay Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/morro-bay/pool-demolition/`.
