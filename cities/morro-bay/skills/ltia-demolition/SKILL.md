...
# Morro Bay — Ltia Demolition Permit

Handles ltia demolition permits in Morro Bay end-to-end.
...
```
## Ready to Submit — Morro Bay Ltia Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ltia-demolition/`. City overlay source: `skills/cities/morro-bay/ltia-demolition/`.
