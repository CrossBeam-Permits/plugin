...
# El Centro — Pool Demolition Permit

Handles pool demolition permits in El Centro end-to-end.
...
```
## Ready to Submit — El Centro Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/el-centro/pool-demolition/`.
