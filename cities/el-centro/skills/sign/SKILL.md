...
# El Centro — Sign Permit

Handles sign permits in El Centro end-to-end.
...
```
## Ready to Submit — El Centro Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/el-centro/sign/`.
