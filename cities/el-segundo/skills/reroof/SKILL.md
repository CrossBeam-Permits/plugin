...
# El Segundo — Reroof Permit

Handles reroof permits in El Segundo end-to-end.
...
```
## Ready to Submit — El Segundo Reroof Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/reroof/`. City overlay source: `skills/cities/el-segundo/reroof/`.
