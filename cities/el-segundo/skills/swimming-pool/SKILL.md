...
# El Segundo — Swimming Pool Permit

Handles swimming pool permits in El Segundo end-to-end.
...
```
## Ready to Submit — El Segundo Swimming Pool Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/swimming-pool/`. City overlay source: `skills/cities/el-segundo/swimming-pool/`.
