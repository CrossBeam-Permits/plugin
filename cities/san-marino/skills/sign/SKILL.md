...
# San Marino — Sign Permit

Handles sign permits in San Marino end-to-end.
...
```
## Ready to Submit — San Marino Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/san-marino/sign/`.
