...
Handles sign permits in Chino end-to-end.
...
```
## Ready to Submit — Chino Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/chino/sign/`.
