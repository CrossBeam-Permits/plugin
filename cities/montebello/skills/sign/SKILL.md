...
# Montebello — Sign Permit

Handles sign permits in Montebello end-to-end.
...
```
## Ready to Submit — Montebello Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/montebello/sign/`.
