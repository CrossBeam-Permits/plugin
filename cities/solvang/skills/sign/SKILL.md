...
Handles sign permits in Solvang end-to-end.
...
```
## Ready to Submit — Solvang Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/solvang/sign/`.
