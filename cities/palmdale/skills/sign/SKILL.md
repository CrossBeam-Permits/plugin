...
# Palmdale — Sign Permit

Handles sign permits in Palmdale end-to-end.
...
```
## Ready to Submit — Palmdale Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/palmdale/sign/`.
