...
# Palm Desert — Pool Demolition Permit

Handles pool demolition permits in Palm Desert end-to-end.
...
```
## Ready to Submit — Palm Desert Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/palm-desert/pool-demolition/`.
