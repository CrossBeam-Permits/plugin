...
# Palm Desert — Sign Permit

Handles sign permits in Palm Desert end-to-end.
...
```
## Ready to Submit — Palm Desert Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/palm-desert/sign/`.
