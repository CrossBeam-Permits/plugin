...
# Woodland — Sign Permit

Handles sign permits in Woodland end-to-end.
...
```
## Ready to Submit — Woodland Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/woodland/sign/`.
