...
# Santa Barbara — Sign Permit

Handles sign permits in Santa Barbara end-to-end.
...
```
## Ready to Submit — Santa Barbara Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/santa-barbara/sign/`.
