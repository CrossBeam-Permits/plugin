...
Handles sign permits in Auburn end-to-end.
...
```
## Ready to Submit — Auburn Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/auburn/sign/`.
