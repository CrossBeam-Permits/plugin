...
# La Verne — Pool Demolition Permit

Handles pool demolition permits in La Verne end-to-end.
...
```
## Ready to Submit — La Verne Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/la-verne/pool-demolition/`.
