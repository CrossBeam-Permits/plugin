...
Handles sign permits in Indio end-to-end.
...
```
## Ready to Submit — Indio Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/indio/sign/`.
