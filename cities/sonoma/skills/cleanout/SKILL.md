...
# Sonoma — Cleanout Permit

Handles cleanout permits in Sonoma end-to-end.
...
```
## Ready to Submit — Sonoma Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/sonoma/cleanout/`.
