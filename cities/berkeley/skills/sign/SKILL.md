...
# Berkeley — Sign Permit

Handles sign permits in Berkeley end-to-end.
...
```
## Ready to Submit — Berkeley Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/berkeley/sign/`.
