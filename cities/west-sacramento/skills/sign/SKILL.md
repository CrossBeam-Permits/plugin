...
# West Sacramento — Sign Permit

Handles sign permits in West Sacramento end-to-end.
...
```
## Ready to Submit — West Sacramento Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/west-sacramento/sign/`.
