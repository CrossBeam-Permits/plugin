...
# McFarland — Sign Permit

Handles sign permits in McFarland end-to-end.
...
```
## Ready to Submit — McFarland Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/mcfarland/sign/`.
