...
# Villa Park — Pool Demolition Permit

Handles pool demolition permits in Villa Park end-to-end.
...
```
## Ready to Submit — Villa Park Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/villa-park/pool-demolition/`.
