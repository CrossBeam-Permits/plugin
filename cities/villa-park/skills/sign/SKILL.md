...
# Villa Park — Sign Permit

Handles sign permits in Villa Park end-to-end.
...
- **1** Permit Threshold — Sign Permit Required — **flag**
- **2** Counter Hours — Critical — **flag**
- **3** Real Estate Signs — Exempt from Permit, Not from Standards — **flag**
- **4** Nameplate / Address Signs — Exempt from Permit — **flag**
- **5** Subdivision Entry / Community ID Monument Signs — **flag**
- **6** Commercial Signs — Santiago Blvd Corridor Only — **flag**
- **7** Illumination — Residential Zones — **flag**
- **8** HOA Interaction — **flag**
- **9** Prohibited Sign Characteristics — **flag**
- **10** Nonconforming Signs — **flag**
...
```
## Ready to Submit — Villa Park Sign Permit
...
| 1 | **Permit Threshold — Sign Permit Required** `[VPMC]` | ⚠️ **flag** | A sign permit is required before locating, erecting, moving, reconstructing, extending, enlarging, converting, or structurally altering any sign, unless the sign type is explicitly exempt. Submit via iWorQ portal: https://villapark.portal.iworq.net — select "Sign" permit type. | VPMC Art. 23-16 |
| 2 | **Counter Hours — Critical** `[VPMC]` | ⚠️ **flag** | Villa Park building counter is open **Mon, Wed, Fri, 8:00–11:00 AM only.** Over-the-counter plan check (if available for simple signs) requires arriving within this window. Inspections: Mon/Wed/Fri, 11:00 AM–2:00 PM with 24-hour advance notice. | CITY.md |
| 3 | **Real Estate Signs — Exempt from Permit, Not from Standards** `[VPMC]` | ⚠️ **flag** | Real estate for-sale / for-lease signs in residential zones are exempt from the permit requirement but must still conform to size and placement standards in VPMC §23-16.5. One sign per parcel; non-illuminated; remove when property is no longer offered for sale/lease. | VPMC §23-16.5 (Residential Zones) |
| 4 | **Nameplate / Address Signs — Exempt from Permit** `[VPMC]` | ⚠️ **flag** | Small nameplate signs (name, address, or both) not exceeding the VPMC size limit are typically exempt from permit requirements. Verify size threshold with building dept; comparable OC residential codes typically set this at ≤2 sq ft. | VPMC Art. 23-16 (Exemptions) |
| 5 | **Subdivision Entry / Community ID Monument Signs** `[VPMC]` | ⚠️ **flag** | Residential subdivision entry/community identification signs are permitted in residential zones, typically as monument-style ground signs at major entrances. Sign area and height limits apply per §23-16.5. These are the most common permitted sign type in Villa Park. | VPMC §23-16.5 (Residential Zones) |
| 6 | **Commercial Signs — Santiago Blvd Corridor Only** `[VPMC]` | ⚠️ **flag** | Commercial signs (wall, monument, freestanding) are only permissible on commercially zoned parcels along Santiago Boulevard. Sign area, height, and number limits for commercial zones apply per the applicable commercial zone article in VPMC Chapter XXIII. Given the minimal commercial footprint, verify current zoning for the specific parcel. | VPMC Ch. XXIII (Commercial Zone Articles) |
| 7 | **Illumination — Residential Zones** `[VPMC]` | ⚠️ **flag** | Illuminated signs in residential zones are generally prohibited or severely limited. Real estate signs must be non-illuminated. Nameplate/address signs may use subtle indirect illumination — verify with building dept. No internally illuminated cabinet or backlit signs in residential zones. | VPMC §23-16.5 (Residential Zones) |
| 8 | **HOA Interaction** `[VPMC]` | ⚠️ **flag** | Villa Park has numerous HOA-governed residential tracts. HOA CC&Rs may impose additional sign restrictions (size, placement, design) beyond VPMC requirements. CC&R compliance is the applicant's responsibility; the city building dept issues the permit per VPMC, but HOA approval may be separately required. | HOA CC&Rs (private; not city code) |
| 9 | **Prohibited Sign Characteristics** `[VPMC]` | ⚠️ **flag** | The following sign characteristics are prohibited city-wide: flashing, sequential, running, chasing, or any motion via lighting / wind / mechanical means. Signs may not resemble traffic control devices, obstruct exits or fire escapes, or interfere with traffic safety. | VPMC Art. 23-16 (General Regulations) |
| 10 | **Nonconforming Signs** `[VPMC]` | ⚠️ **flag** | Signs lawfully in existence at adoption of current sign ordinance that do not conform to current standards are nonconforming. They may not be expanded or structurally altered; normal maintenance is permitted. Any modification triggering a permit must bring the sign into full conformance. | VPMC Art. 23-16 (Nonconforming Signs) |

---

## References

Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/villa-park/sign/`.
