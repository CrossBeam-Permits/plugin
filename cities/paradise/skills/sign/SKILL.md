...
# Paradise — Sign Permit

Handles sign permits in Paradise end-to-end.
...
```
## Ready to Submit — Paradise Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/paradise/sign/`.
