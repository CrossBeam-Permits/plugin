...
# Woodside — Sign Permit

Handles sign permits in Woodside end-to-end.
...
```
## Ready to Submit — Woodside Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/woodside/sign/`.
