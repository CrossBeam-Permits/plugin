...
# Hillsborough — Sign Permit

Handles sign permits in Hillsborough end-to-end.
...
```
## Ready to Submit — Hillsborough Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/hillsborough/sign/`.
