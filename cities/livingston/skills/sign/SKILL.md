...
# Livingston — Sign Permit

Handles sign permits in Livingston end-to-end.
...
```
## Ready to Submit — Livingston Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/livingston/sign/`.
