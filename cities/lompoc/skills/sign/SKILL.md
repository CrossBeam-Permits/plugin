...
Handles sign permits in Lompoc end-to-end.
...
```
## Ready to Submit — Lompoc Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/lompoc/sign/`.
