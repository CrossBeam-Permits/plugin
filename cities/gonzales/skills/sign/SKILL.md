...
# Gonzales — Sign Permit

Handles sign permits in Gonzales end-to-end.
...
```
## Ready to Submit — Gonzales Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/gonzales/sign/`.
