...
# Trinidad — Sign Permit

Handles sign permits in Trinidad end-to-end.
...
```
## Ready to Submit — Trinidad Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/trinidad/sign/`.
