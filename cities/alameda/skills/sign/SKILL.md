...
Handles sign permits in Alameda end-to-end.
...
```
## Ready to Submit — Alameda Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/alameda/sign/`.
