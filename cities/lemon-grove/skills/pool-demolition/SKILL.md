...
# Lemon Grove — Pool Demolition Permit

Handles pool demolition permits in Lemon Grove end-to-end.
...
```
## Ready to Submit — Lemon Grove Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/lemon-grove/pool-demolition/`.
