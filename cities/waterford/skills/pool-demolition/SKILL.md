...
# Waterford — Pool Demolition Permit

Handles pool demolition permits in Waterford end-to-end.
...
```
## Ready to Submit — Waterford Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/waterford/pool-demolition/`.
