...
# Waterford — Sign Permit

Handles sign permits in Waterford end-to-end.
...
```
## Ready to Submit — Waterford Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/waterford/sign/`.
