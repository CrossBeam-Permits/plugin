...
Handles sign permits in Atwater end-to-end.
...
```
## Ready to Submit — Atwater Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/atwater/sign/`.
