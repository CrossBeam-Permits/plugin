...
# Palos Verdes Estates — Sign Permit

Handles sign permits in Palos Verdes Estates end-to-end.
...
```
## Ready to Submit — Palos Verdes Estates Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/palos-verdes-estates/sign/`.
