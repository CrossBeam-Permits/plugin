...
# Palos Verdes Estates — Pool Demolition Permit

Handles pool demolition permits in Palos Verdes Estates end-to-end.
...
```
## Ready to Submit — Palos Verdes Estates Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/palos-verdes-estates/pool-demolition/`.
