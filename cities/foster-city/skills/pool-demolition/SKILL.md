...
# Foster City — Pool Demolition Permit

Handles pool demolition permits in Foster City end-to-end.
...
```
## Ready to Submit — Foster City Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/foster-city/pool-demolition/`.
