...
# Loyalton — Sign Permit

Handles sign permits in Loyalton end-to-end.
...
```
## Ready to Submit — Loyalton Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/loyalton/sign/`.
