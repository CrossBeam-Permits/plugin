...
# Oroville — Sign Permit

Handles sign permits in Oroville end-to-end.
...
```
## Ready to Submit — Oroville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/oroville/sign/`.
