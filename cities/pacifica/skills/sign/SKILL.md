...
# Pacifica — Sign Permit

Handles sign permits in Pacifica end-to-end.
...
```
## Ready to Submit — Pacifica Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/pacifica/sign/`.
