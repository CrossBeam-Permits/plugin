...
# Burbank — Pool Demolition Permit

Handles pool demolition permits in Burbank end-to-end.
...
```
## Ready to Submit — Burbank Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/burbank/pool-demolition/`.
