...
Handles sign permits in Burbank end-to-end.
...
```
## Ready to Submit — Burbank Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/burbank/sign/`.
