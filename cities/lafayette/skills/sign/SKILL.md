...
# Lafayette — Sign Permit

Handles sign permits in Lafayette end-to-end.
...
```
## Ready to Submit — Lafayette Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/lafayette/sign/`.
