...
Handles sign permits in Arcadia end-to-end.
...
```
## Ready to Submit — Arcadia Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/arcadia/sign/`.
