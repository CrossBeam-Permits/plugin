...
Handles hvac permits in Orange end-to-end.
...
```
## Ready to Submit — Orange Hvac Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/hvac/`. City overlay source: `skills/cities/orange/hvac/`.
