...
# Orange — Patio Cover Permit

Handles patio cover permits in Orange end-to-end.
...
```
## Ready to Submit — Orange Patio Cover Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/patio-cover/`. City overlay source: `skills/cities/orange/patio-cover/`.
