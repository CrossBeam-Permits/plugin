...
# Orange — Reroof Permit

Handles reroof permits in Orange end-to-end.
...
```
## Ready to Submit — Orange Reroof Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/reroof/`. City overlay source: `skills/cities/orange/reroof/`.
