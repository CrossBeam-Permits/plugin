...
Handles sign permits in Orange end-to-end.
...
```
## Ready to Submit — Orange Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/orange/sign/`.
