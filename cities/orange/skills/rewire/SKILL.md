...
# Orange — Rewire Permit

Handles rewire permits in Orange end-to-end.
...
```
## Ready to Submit — Orange Rewire Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/rewire/`. City overlay source: `skills/cities/orange/rewire/`.
