...
# Orange — Cleanout Permit

Handles cleanout permits in Orange end-to-end.
...
```
## Ready to Submit — Orange Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/orange/cleanout/`.
