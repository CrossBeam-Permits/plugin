...
# Orange — Ev Charger Permit

Handles ev charger permits in Orange end-to-end.
...
```
## Ready to Submit — Orange Ev Charger Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ev-charger/`. City overlay source: `skills/cities/orange/ev-charger/`.
