...
# Orange — Ltia Demolition Permit

Handles ltia demolition permits in Orange end-to-end.
...
```
## Ready to Submit — Orange Ltia Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ltia-demolition/`. City overlay source: `skills/cities/orange/ltia-demolition/`.
