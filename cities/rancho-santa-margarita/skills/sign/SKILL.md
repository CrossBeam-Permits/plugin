...
# Rancho Santa Margarita — Sign Permit

Handles sign permits in Rancho Santa Margarita end-to-end.
...
- **1** Planned Sign Program (PSP) — **flag**
- **2** Planning Division review — **flag**
- **3** Temporary signs — **flag**
- **4** Electronic message boards — **flag**
...
```
## Ready to Submit — Rancho Santa Margarita Sign Permit
...
| 1 | **Planned Sign Program (PSP)** `[RSMMC]` | ⚠️ **flag** | Multi-tenant commercial sites require an approved PSP prior to individual sign permits. The PSP governs sign types, sizes, locations, and illumination for the entire site. | RSMMC Title 9 |
| 2 | **Planning Division review** `[RSMMC]` | ⚠️ **flag** | Planning Division reviews sign programs and individual sign permits for code compliance. Contact Planning before submittal for multi-tenant sites. | RSMMC Title 9 |
| 3 | **Temporary signs** `[RSMMC]` | ⚠️ **flag** | Temporary signs have separate standards — duration limits, size limits, and placement restrictions. | RSMMC Title 9 |
| 4 | **Electronic message boards** `[RSMMC]` | ⚠️ **flag** | Electronic/digital message signs require additional review — may be restricted or prohibited in certain zones. | RSMMC Title 9 |
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/rancho-santa-margarita/sign/`.
