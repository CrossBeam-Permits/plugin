...
# Sacramento — Sign Permit

Handles sign permits in Sacramento end-to-end.
...
```
## Ready to Submit — Sacramento Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/sacramento/sign/`.
