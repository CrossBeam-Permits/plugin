...
# Menlo Park — Pool Demolition Permit

Handles pool demolition permits in Menlo Park end-to-end.
...
```
## Ready to Submit — Menlo Park Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/menlo-park/pool-demolition/`.
