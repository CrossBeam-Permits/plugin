...
# Indian Wells — Pool Demolition Permit

Handles pool demolition permits in Indian Wells end-to-end.
...
```
## Ready to Submit — Indian Wells Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/indian-wells/pool-demolition/`.
