...
# Indian Wells — Sign Permit

Handles sign permits in Indian Wells end-to-end.
...
```
## Ready to Submit — Indian Wells Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/indian-wells/sign/`.
