...
Handles sign permits in Dinuba end-to-end.
...
```
## Ready to Submit — Dinuba Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/dinuba/sign/`.
