...
# Palm Springs — Sign Permit

Handles sign permits in Palm Springs end-to-end.
...
```
## Ready to Submit — Palm Springs Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/palm-springs/sign/`.
