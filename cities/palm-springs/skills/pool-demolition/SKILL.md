...
# Palm Springs — Pool Demolition Permit

Handles pool demolition permits in Palm Springs end-to-end.
...
```
## Ready to Submit — Palm Springs Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/palm-springs/pool-demolition/`.
