...
# Firebaugh — Sign Permit

Handles sign permits in Firebaugh end-to-end.
...
```
## Ready to Submit — Firebaugh Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/firebaugh/sign/`.
