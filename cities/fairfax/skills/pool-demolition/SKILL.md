...
# Fairfax — Pool Demolition Permit

Handles pool demolition permits in Fairfax end-to-end.
...
```
## Ready to Submit — Fairfax Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/fairfax/pool-demolition/`.
