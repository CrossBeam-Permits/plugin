...
# Imperial — Sign Permit

Handles sign permits in Imperial end-to-end.
...
```
## Ready to Submit — Imperial Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/imperial/sign/`.
