...
# Yorba Linda — Pool Demolition Permit

Handles pool demolition permits in Yorba Linda end-to-end.
...
```
## Ready to Submit — Yorba Linda Pool Demolition Permit
...
| 1 | **Procedure 003** `[YLMC]` | ⚠️ **flag** | Pool demolition must follow City Procedure 003 — city-specific demolition process including fill material requirements, compaction testing, drainage, and final grade | City Procedure 003 |
| 2 | **Utility disconnection** `[YLMC]` | ⚠️ **flag** | All pool utilities (gas, electrical, water) must be properly disconnected and capped before demolition begins | City Procedure 003 |
...
| 6 | **Special hazards screening** `[YLMC]` | ⚠️ **flag** | Check for oil wells, faults, liquefaction — may affect demolition approach and fill requirements | City procedure; see CITY.md |
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/yorba-linda/pool-demolition/`.
