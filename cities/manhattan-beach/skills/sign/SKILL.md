...
# Manhattan Beach — Sign Permit

Handles sign permits in Manhattan Beach end-to-end.
...
```
## Ready to Submit — Manhattan Beach Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/manhattan-beach/sign/`.
