...
# Manhattan Beach — Pool Demolition Permit

Handles pool demolition permits in Manhattan Beach end-to-end.
...
```
## Ready to Submit — Manhattan Beach Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/manhattan-beach/pool-demolition/`.
