...
# Atherton — Sign Permit

Handles sign permits in Atherton end-to-end.
...
```
## Ready to Submit — Atherton Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/atherton/sign/`.
