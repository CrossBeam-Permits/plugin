...
# Atherton — Pool Demolition Permit

Handles pool demolition permits in Atherton end-to-end.
...
```
## Ready to Submit — Atherton Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/atherton/pool-demolition/`.
