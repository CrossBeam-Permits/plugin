...
# Thousand Oaks — Sign Permit

Handles sign permits in Thousand Oaks end-to-end.
...
```
## Ready to Submit — Thousand Oaks Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/thousand-oaks/sign/`.
