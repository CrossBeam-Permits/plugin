...
# Thousand Oaks — Pool Demolition Permit

Handles pool demolition permits in Thousand Oaks end-to-end.
...
```
## Ready to Submit — Thousand Oaks Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/thousand-oaks/pool-demolition/`.
