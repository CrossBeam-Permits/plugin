...
# Albany — Pool Demolition Permit

Handles pool demolition permits in Albany end-to-end.
...
```
## Ready to Submit — Albany Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/albany/pool-demolition/`.
