...
Handles sign permits in Albany end-to-end.
...
```
## Ready to Submit — Albany Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/albany/sign/`.
