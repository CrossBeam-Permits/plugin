...
Handles sign permits in Taft end-to-end.
...
```
## Ready to Submit — Taft Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/taft/sign/`.
