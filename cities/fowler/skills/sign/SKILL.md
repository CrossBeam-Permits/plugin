...
Handles sign permits in Fowler end-to-end.
...
```
## Ready to Submit — Fowler Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/fowler/sign/`.
