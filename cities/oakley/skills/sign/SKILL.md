...
Handles sign permits in Oakley end-to-end.
...
```
## Ready to Submit — Oakley Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/oakley/sign/`.
