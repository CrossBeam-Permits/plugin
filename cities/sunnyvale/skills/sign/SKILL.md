...
# City of Sunnyvale — Sign Permit

Handles sign permits in City of Sunnyvale end-to-end.
...
```
## Ready to Submit — City of Sunnyvale Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/sunnyvale/sign/`.
