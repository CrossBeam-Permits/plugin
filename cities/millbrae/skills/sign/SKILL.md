...
# Millbrae — Sign Permit

Handles sign permits in Millbrae end-to-end.
...
```
## Ready to Submit — Millbrae Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/millbrae/sign/`.
