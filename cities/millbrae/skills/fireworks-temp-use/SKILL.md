...
# Millbrae — Fireworks Temp Use Permit

Handles fireworks temp use permits in Millbrae end-to-end.
...
```
## Ready to Submit — Millbrae Fireworks Temp Use Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/fireworks-temp-use/`. City overlay source: `skills/cities/millbrae/fireworks-temp-use/`.
