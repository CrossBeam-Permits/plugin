...
# Oceanside — Sign Permit

Handles sign permits in Oceanside end-to-end.
...
```
## Ready to Submit — Oceanside Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/oceanside/sign/`.
