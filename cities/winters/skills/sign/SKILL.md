...
Handles sign permits in Winters end-to-end.
...
```
## Ready to Submit — Winters Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/winters/sign/`.
