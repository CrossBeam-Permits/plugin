...
# Hanford — Pool Demolition Permit

Handles pool demolition permits in Hanford end-to-end.
...
```
## Ready to Submit — Hanford Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/hanford/pool-demolition/`.
