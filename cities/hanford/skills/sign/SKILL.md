...
Handles sign permits in Hanford end-to-end.
...
```
## Ready to Submit — Hanford Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/hanford/sign/`.
