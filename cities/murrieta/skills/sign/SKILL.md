...
# Murrieta — Sign Permit

Handles sign permits in Murrieta end-to-end.
...
```
## Ready to Submit — Murrieta Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/murrieta/sign/`.
