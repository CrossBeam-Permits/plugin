...
# Baldwin Park — Pool Demolition Permit

Handles pool demolition permits in Baldwin Park end-to-end.
...
```
## Ready to Submit — Baldwin Park Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/baldwin-park/pool-demolition/`.
