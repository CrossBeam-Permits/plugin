...
# Roseville — Sign Permit

Handles sign permits in Roseville end-to-end.
...
```
## Ready to Submit — Roseville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/roseville/sign/`.
