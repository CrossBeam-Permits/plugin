...
# Malibu — Pool Demolition Permit

Handles pool demolition permits in Malibu end-to-end.
...
```
## Ready to Submit — Malibu Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/malibu/pool-demolition/`.
