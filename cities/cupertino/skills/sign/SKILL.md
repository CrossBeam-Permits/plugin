...
# Cupertino — Sign Permit

Handles sign permits in Cupertino end-to-end.
...
```
## Ready to Submit — Cupertino Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/cupertino/sign/`.
