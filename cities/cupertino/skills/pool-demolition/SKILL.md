...
# Cupertino — Pool Demolition Permit

Handles pool demolition permits in Cupertino end-to-end.
...
```
## Ready to Submit — Cupertino Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/cupertino/pool-demolition/`.
