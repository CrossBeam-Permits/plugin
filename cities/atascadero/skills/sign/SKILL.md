...
# Atascadero — Sign Permit

Handles sign permits in Atascadero end-to-end.
...
```
## Ready to Submit — Atascadero Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/atascadero/sign/`.
