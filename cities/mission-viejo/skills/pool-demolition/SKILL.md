...
# Mission Viejo — Pool Demolition Permit

Handles pool demolition permits in Mission Viejo end-to-end.
...
- **1** Grading permit — separate track — **flag**
- **2** Public Works / Engineering clearance — **flag**
- **3** HOA / ARC notification — **flag**
- **4** Utility disconnection — **flag**
- **5** SMWD verification — **flag**
- **6** OC Coalition amendments — **flag**
- **8** Contact — **flag**
...
```
## Ready to Submit — Mission Viejo Pool Demolition Permit
...
| 1 | **Grading permit — separate track** `[MVMC]` | ⚠️ **flag** | If excavation/backfill scope exceeds CBC thresholds OR affects drainage patterns, a separate grading permit is required under MVMC Title 8, Ch. 8.10; soils compaction report is likely required for backfill certification | MVMC Ch. 8.10 |
| 2 | **Public Works / Engineering clearance** `[MVMC]` | ⚠️ **flag** | Coordinate with Public Works / Engineering for grading, drainage, and encroachment review when grading component is triggered | CITY.md — Required Clearances |
| 3 | **HOA / ARC notification** `[MVMC]` | ⚠️ **flag** | Most Mission Viejo residential properties are subject to HOA CC&Rs; ARC approval or notification may be required for pool removal as it changes the rear yard; city does not enforce CC&Rs but applicant should confirm with HOA prior to permit submission | CITY.md — Master-Planned Community section |
| 4 | **Utility disconnection** `[MVMC]` | ⚠️ **flag** | Confirm gas, electric, and water service to pool equipment are properly abandoned; coordinate with SCE (electric), SoCalGas (gas), and SMWD (water/backwash) | CITY.md — Utility Providers |
| 5 | **SMWD verification** `[MVMC]` | ⚠️ **flag** | If pool has a dedicated water connection or backwash line to sewer, confirm abandonment/disconnection with Santa Margarita Water District | CITY.md — Utility Providers |
| 6 | **OC Coalition amendments** `[MVMC]` | ⚠️ **flag** | Local amendments coordinated through Orange County Coalition for Building Code Uniformity apply | MVMC Title 8, Ch. 8.02 |
| 8 | **Contact** `[MVMC]` | ⚠️ **flag** | Building Services: bldgservices@cityofmissionviejo.org · (949) 470-3054 | CITY.md |
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/mission-viejo/pool-demolition/`.
