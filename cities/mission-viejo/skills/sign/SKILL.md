...
# Mission Viejo — Sign Permit

Handles sign permits in Mission Viejo end-to-end.
...
- **1** Step 1 — Planning Division approval — **flag**
- **2** Step 2 — Building Services permit — **flag**
- **3** Zone identification — **flag**
- **4** Temporary promotional signs — **flag**
- **5** Illumination compliance — **flag**
- **6** HOA/ARC — commercial context — **flag**
- **7** OCFA address numbers — **flag**
- **8** No CDP required — **flag**
- **10** Permit contact — **flag**
...
```
## Ready to Submit — Mission Viejo Sign Permit
...
| 1 | **Step 1 — Planning Division approval** `[MVMC]` | ⚠️ **flag** | Submit sign design, dimensions, placement, and zone compliance documentation to Planning Division FIRST; approval required before building permit can be issued | MVMC §9.11 / Title 14 |
| 2 | **Step 2 — Building Services permit** `[MVMC]` | ⚠️ **flag** | After Planning approval, submit building permit application via EnerGov for structural and electrical review; include Planning approval documentation with permit submittal | MVMC Title 8; EnerGov portal |
| 3 | **Zone identification** `[MVMC]` | ⚠️ **flag** | Plans must clearly identify the applicable commercial zone (CC, CH, CN, CR, OP, BP); sign type, area, and height limits differ by zone — confirm limits with Planning Division | MVMC §9.11.020 / Title 14 |
| 4 | **Temporary promotional signs** `[MVMC]` | ⚠️ **flag** | Limited to **3 events per year**; maximum **42 days total per year**; obtain required approvals before installation | MVMC §9.11 / Title 14 |
| 5 | **Illumination compliance** `[MVMC]` | ⚠️ **flag** | All illuminated sign wiring must comply with 2025 CEC; underground conduit required for freestanding/monument sign wiring | MVMC Title 8, Ch. 8.06 |
| 6 | **HOA/ARC — commercial context** `[MVMC]` | ⚠️ **flag** | Commercial properties within master-planned community areas or mixed-use districts may have CC&R restrictions on signage; verify with property management before submitting | CC&Rs (city does not enforce) |
| 7 | **OCFA address numbers** `[MVMC]` | ⚠️ **flag** | Address numbers must be minimum 6" height per OCFA requirements; confirm sign does not obscure required address identification | OCFA requirements; CITY.md |
| 8 | **No CDP required** `[MVMC]` | ⚠️ **flag** | Mission Viejo is inland — no Coastal Development Permit applies to any sign permit | CITY.md |
| 10 | **Permit contact** `[MVMC]` | ⚠️ **flag** | Building Services: (949) 470-3054 · bldgservices@cityofmissionviejo.org; Planning Division: Community Development Department | CITY.md |

---

## References

Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/mission-viejo/sign/`.
