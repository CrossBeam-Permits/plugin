...
# Riverside — Sign Permit

Handles sign permits in Riverside end-to-end.
...
```
## Ready to Submit — Riverside Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/riverside/sign/`.
