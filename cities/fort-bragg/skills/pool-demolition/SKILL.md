...
# Fort Bragg — Pool Demolition Permit

Handles pool demolition permits in Fort Bragg end-to-end.
...
```
## Ready to Submit — Fort Bragg Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/fort-bragg/pool-demolition/`.
