...
# Fort Bragg — Sign Permit

Handles sign permits in Fort Bragg end-to-end.
...
```
## Ready to Submit — Fort Bragg Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/fort-bragg/sign/`.
