...
# Wheatland — Sign Permit

Handles sign permits in Wheatland end-to-end.
...
```
## Ready to Submit — Wheatland Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/wheatland/sign/`.
