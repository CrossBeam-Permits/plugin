...
# Buena Park — Sign Permit

Handles sign permits in Buena Park end-to-end.
...
```
## Ready to Submit — Buena Park Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/buena-park/sign/`.
