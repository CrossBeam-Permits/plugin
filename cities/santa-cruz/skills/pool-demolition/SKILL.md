...
# Santa Cruz — Pool Demolition Permit

Handles pool demolition permits in Santa Cruz end-to-end.
...
```
## Ready to Submit — Santa Cruz Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/santa-cruz/pool-demolition/`.
