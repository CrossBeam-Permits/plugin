...
# Santa Cruz — Sign Permit

Handles sign permits in Santa Cruz end-to-end.
...
```
## Ready to Submit — Santa Cruz Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/santa-cruz/sign/`.
