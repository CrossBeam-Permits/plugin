...
# Blue Lake — Pool Demolition Permit

Handles pool demolition permits in Blue Lake end-to-end.
...
```
## Ready to Submit — Blue Lake Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/blue-lake/pool-demolition/`.
