...
# Blue Lake — Sign Permit

Handles sign permits in Blue Lake end-to-end.
...
```
## Ready to Submit — Blue Lake Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/blue-lake/sign/`.
