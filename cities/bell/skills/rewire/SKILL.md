...
Handles rewire permits in Bell end-to-end.
...
```
## Ready to Submit — Bell Rewire Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/rewire/`. City overlay source: `skills/cities/bell/rewire/`.
