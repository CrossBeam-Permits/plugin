...
Handles hvac permits in Bell end-to-end.
...
```
## Ready to Submit — Bell Hvac Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/hvac/`. City overlay source: `skills/cities/bell/hvac/`.
