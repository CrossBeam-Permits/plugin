...
Handles sign permits in Downey end-to-end.
...
```
## Ready to Submit — Downey Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/downey/sign/`.
