...
# Solana Beach — Pool Demolition Permit

Handles pool demolition permits in Solana Beach end-to-end.
...
```
## Ready to Submit — Solana Beach Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/solana-beach/pool-demolition/`.
