...
# Solana Beach — Sign Permit

Handles sign permits in Solana Beach end-to-end.
...
```
## Ready to Submit — Solana Beach Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/solana-beach/sign/`.
