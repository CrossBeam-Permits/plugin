...
# Hesperia — Sign Permit

Handles sign permits in Hesperia end-to-end.
...
```
## Ready to Submit — Hesperia Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/hesperia/sign/`.
