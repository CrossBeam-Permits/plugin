...
# Porterville — Sign Permit

Handles sign permits in Porterville end-to-end.
...
```
## Ready to Submit — Porterville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/porterville/sign/`.
