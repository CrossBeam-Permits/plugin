...
# San Pablo — Pool Demolition Permit

Handles pool demolition permits in San Pablo end-to-end.
...
```
## Ready to Submit — San Pablo Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/san-pablo/pool-demolition/`.
