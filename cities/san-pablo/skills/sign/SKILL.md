...
# San Pablo — Sign Permit

Handles sign permits in San Pablo end-to-end.
...
```
## Ready to Submit — San Pablo Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/san-pablo/sign/`.
