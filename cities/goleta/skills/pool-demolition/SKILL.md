...
# Goleta — Pool Demolition Permit

Handles pool demolition permits in Goleta end-to-end.
...
```
## Ready to Submit — Goleta Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/goleta/pool-demolition/`.
