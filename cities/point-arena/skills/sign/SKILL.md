...
# Point Arena — Sign Permit

Handles sign permits in Point Arena end-to-end.
...
```
## Ready to Submit — Point Arena Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/point-arena/sign/`.
