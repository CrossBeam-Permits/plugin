...
# Livermore — Pool Demolition Permit

Handles pool demolition permits in Livermore end-to-end.
...
```
## Ready to Submit — Livermore Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/livermore/pool-demolition/`.
