...
Handles sign permits in Brawley end-to-end.
...
```
## Ready to Submit — Brawley Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/brawley/sign/`.
