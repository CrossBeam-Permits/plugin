...
# Norco — Pool Demolition Permit

Handles pool demolition permits in Norco end-to-end.
...
```
## Ready to Submit — Norco Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/norco/pool-demolition/`.
