...
# Los Altos Hills — Sign Permit

Handles sign permits in Los Altos Hills end-to-end.
...
```
## Ready to Submit — Los Altos Hills Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/los-altos-hills/sign/`.
