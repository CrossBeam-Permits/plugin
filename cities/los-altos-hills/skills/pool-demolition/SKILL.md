...
# Los Altos Hills — Pool Demolition Permit

Handles pool demolition permits in Los Altos Hills end-to-end.
...
```
## Ready to Submit — Los Altos Hills Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/los-altos-hills/pool-demolition/`.
