...
# Whittier — Pool Demolition Permit

Handles pool demolition permits in Whittier end-to-end.
...
```
## Ready to Submit — Whittier Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/whittier/pool-demolition/`.
