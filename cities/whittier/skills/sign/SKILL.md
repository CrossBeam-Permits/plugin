...
# Whittier — Sign Permit

Handles sign permits in Whittier end-to-end.
...
```
## Ready to Submit — Whittier Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/whittier/sign/`.
