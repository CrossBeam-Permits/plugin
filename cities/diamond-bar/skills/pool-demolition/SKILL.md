...
# Diamond Bar — Pool Demolition Permit

Handles pool demolition permits in Diamond Bar end-to-end.
...
```
## Ready to Submit — Diamond Bar Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/diamond-bar/pool-demolition/`.
