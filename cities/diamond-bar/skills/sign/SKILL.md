...
# Diamond Bar — Sign Permit

Handles sign permits in Diamond Bar end-to-end.
...
```
## Ready to Submit — Diamond Bar Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/diamond-bar/sign/`.
