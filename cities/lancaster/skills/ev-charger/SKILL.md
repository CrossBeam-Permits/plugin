...
# Lancaster — Ev Charger Permit

Handles ev charger permits in Lancaster end-to-end.
...
```
## Ready to Submit — Lancaster Ev Charger Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ev-charger/`. City overlay source: `skills/cities/lancaster/ev-charger/`.
