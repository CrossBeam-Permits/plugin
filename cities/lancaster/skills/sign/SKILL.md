...
# Lancaster — Sign Permit

Handles sign permits in Lancaster end-to-end.
...
```
## Ready to Submit — Lancaster Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/lancaster/sign/`.
