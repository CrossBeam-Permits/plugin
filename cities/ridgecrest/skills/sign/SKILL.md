...
# Ridgecrest — Sign Permit

Handles sign permits in Ridgecrest end-to-end.
...
```
## Ready to Submit — Ridgecrest Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/ridgecrest/sign/`.
