...
# Ridgecrest — Pool Demolition Permit

Handles pool demolition permits in Ridgecrest end-to-end.
...
```
## Ready to Submit — Ridgecrest Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/ridgecrest/pool-demolition/`.
