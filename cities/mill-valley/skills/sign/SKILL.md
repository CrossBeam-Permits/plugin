...
# Mill Valley — Sign Permit

Handles sign permits in Mill Valley end-to-end.
...
```
## Ready to Submit — Mill Valley Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/mill-valley/sign/`.
