...
# Dana Point — Pool Demolition Permit

Handles pool demolition permits in Dana Point end-to-end.
...
```
## Ready to Submit — Dana Point Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/dana-point/pool-demolition/`.
