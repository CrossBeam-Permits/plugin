...
# Dana Point — Sign Permit

Handles sign permits in Dana Point end-to-end.
...
```
## Ready to Submit — Dana Point Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/dana-point/sign/`.
