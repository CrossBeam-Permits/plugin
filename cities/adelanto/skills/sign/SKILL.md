...
# Adelanto — Sign Permit

Handles sign permits in Adelanto end-to-end.
...
```
## Ready to Submit — Adelanto Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/adelanto/sign/`.
