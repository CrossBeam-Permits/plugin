...
# Fortuna — Pool Demolition Permit

Handles pool demolition permits in Fortuna end-to-end.
...
```
## Ready to Submit — Fortuna Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/fortuna/pool-demolition/`.
