...
# Clearlake — Sign Permit

Handles sign permits in Clearlake end-to-end.
...
```
## Ready to Submit — Clearlake Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/clearlake/sign/`.
