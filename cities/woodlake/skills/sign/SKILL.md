...
# Woodlake — Sign Permit

Handles sign permits in Woodlake end-to-end.
...
```
## Ready to Submit — Woodlake Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/woodlake/sign/`.
