...
Handles sign permits in Fontana end-to-end.
...
```
## Ready to Submit — Fontana Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/fontana/sign/`.
