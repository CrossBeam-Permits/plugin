...
# Rio Vista — Sign Permit

Handles sign permits in Rio Vista end-to-end.
...
```
## Ready to Submit — Rio Vista Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/rio-vista/sign/`.
