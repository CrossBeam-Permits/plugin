...
# Piedmont — Sign Permit

Handles sign permits in Piedmont end-to-end.
...
```
## Ready to Submit — Piedmont Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/piedmont/sign/`.
