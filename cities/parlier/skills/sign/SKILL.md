...
Handles sign permits in Parlier end-to-end.
...
```
## Ready to Submit — Parlier Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/parlier/sign/`.
