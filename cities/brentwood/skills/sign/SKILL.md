...
# Brentwood — Sign Permit

Handles sign permits in Brentwood end-to-end.
...
```
## Ready to Submit — Brentwood Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/brentwood/sign/`.
