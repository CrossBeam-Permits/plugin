...
# Martinez — Sign Permit

Handles sign permits in Martinez end-to-end.
...
```
## Ready to Submit — Martinez Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/martinez/sign/`.
