...
# Costa Mesa — Sign Permit

Handles sign permits in Costa Mesa end-to-end.
...
```
## Ready to Submit — Costa Mesa Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/costa-mesa/sign/`.
