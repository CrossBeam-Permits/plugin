...
# Costa Mesa — Pool Demolition Permit

Handles pool demolition permits in Costa Mesa end-to-end.
...
```
## Ready to Submit — Costa Mesa Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/costa-mesa/pool-demolition/`.
