...
# San Anselmo — Sign Permit

Handles sign permits in San Anselmo end-to-end.
...
```
## Ready to Submit — San Anselmo Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/san-anselmo/sign/`.
