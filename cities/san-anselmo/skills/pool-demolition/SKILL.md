...
# San Anselmo — Pool Demolition Permit

Handles pool demolition permits in San Anselmo end-to-end.
...
```
## Ready to Submit — San Anselmo Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/san-anselmo/pool-demolition/`.
