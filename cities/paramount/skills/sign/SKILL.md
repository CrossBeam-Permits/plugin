...
# Paramount — Sign Permit

Handles sign permits in Paramount end-to-end.
...
```
## Ready to Submit — Paramount Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/paramount/sign/`.
