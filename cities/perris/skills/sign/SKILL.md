...
Handles sign permits in Perris end-to-end.
...
```
## Ready to Submit — Perris Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/perris/sign/`.
