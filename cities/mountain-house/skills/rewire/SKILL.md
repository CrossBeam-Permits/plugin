...
# City of Mountain House — Rewire Permit

Handles rewire permits in City of Mountain House end-to-end.
...
```
## Ready to Submit — City of Mountain House Rewire Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/rewire/`. City overlay source: `skills/cities/mountain-house/rewire/`.
