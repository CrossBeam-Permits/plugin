...
# City of Mountain House — Ltia Demolition Permit

Handles ltia demolition permits in City of Mountain House end-to-end.
...
```
## Ready to Submit — City of Mountain House Ltia Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ltia-demolition/`. City overlay source: `skills/cities/mountain-house/ltia-demolition/`.
