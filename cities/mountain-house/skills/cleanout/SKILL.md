...
# City of Mountain House — Cleanout Permit

Handles cleanout permits in City of Mountain House end-to-end.
...
```
## Ready to Submit — City of Mountain House Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/mountain-house/cleanout/`.
