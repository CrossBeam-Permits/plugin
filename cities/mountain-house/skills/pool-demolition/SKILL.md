...
# City of Mountain House — Pool Demolition Permit

Handles pool demolition permits in City of Mountain House end-to-end.
...
```
## Ready to Submit — City of Mountain House Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/mountain-house/pool-demolition/`.
