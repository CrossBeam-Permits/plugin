...
# Yucca Valley — Sign Permit

Handles sign permits in Yucca Valley end-to-end.
...
```
## Ready to Submit — Yucca Valley Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/yucca-valley/sign/`.
