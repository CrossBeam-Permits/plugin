...
Handles sign permits in Lynwood end-to-end.
...
```
## Ready to Submit — Lynwood Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/lynwood/sign/`.
