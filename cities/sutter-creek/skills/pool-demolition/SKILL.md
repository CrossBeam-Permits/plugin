...
# Sutter Creek — Pool Demolition Permit

Handles pool demolition permits in Sutter Creek end-to-end.
...
```
## Ready to Submit — Sutter Creek Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/sutter-creek/pool-demolition/`.
