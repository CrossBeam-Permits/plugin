...
# Sutter Creek — Sign Permit

Handles sign permits in Sutter Creek end-to-end.
...
```
## Ready to Submit — Sutter Creek Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/sutter-creek/sign/`.
