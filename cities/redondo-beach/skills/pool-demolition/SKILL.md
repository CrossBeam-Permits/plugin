...
# Redondo Beach — Pool Demolition Permit

Handles pool demolition permits in Redondo Beach end-to-end.
...
```
## Ready to Submit — Redondo Beach Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/redondo-beach/pool-demolition/`.
