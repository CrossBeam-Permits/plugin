...
# Highland — Sign Permit

Handles sign permits in Highland end-to-end.
...
```
## Ready to Submit — Highland Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/highland/sign/`.
