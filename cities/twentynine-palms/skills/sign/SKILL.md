...
# Twentynine Palms — Sign Permit

Handles sign permits in Twentynine Palms end-to-end.
...
```
## Ready to Submit — Twentynine Palms Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/twentynine-palms/sign/`.
