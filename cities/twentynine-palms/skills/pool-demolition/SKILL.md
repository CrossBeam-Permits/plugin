...
# Twentynine Palms — Pool Demolition Permit

Handles pool demolition permits in Twentynine Palms end-to-end.
...
```
## Ready to Submit — Twentynine Palms Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/twentynine-palms/pool-demolition/`.
