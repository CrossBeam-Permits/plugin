...
# Newport Beach — Sign Permit

Handles sign permits in Newport Beach end-to-end.
...
```
## Ready to Submit — Newport Beach Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/newport-beach/sign/`.
