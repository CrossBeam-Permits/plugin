...
# Newport Beach — Pool Demolition Permit

Handles pool demolition permits in Newport Beach end-to-end.
...
```
## Ready to Submit — Newport Beach Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/newport-beach/pool-demolition/`.
