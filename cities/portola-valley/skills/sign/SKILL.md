...
# Portola Valley — Sign Permit

Handles sign permits in Portola Valley end-to-end.
...
```
## Ready to Submit — Portola Valley Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/portola-valley/sign/`.
