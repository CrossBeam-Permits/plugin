...
# Ferndale — Sign Permit

Handles sign permits in Ferndale end-to-end.
...
```
## Ready to Submit — Ferndale Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/ferndale/sign/`.
