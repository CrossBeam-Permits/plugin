...
# South El Monte — Sign Permit

Handles sign permits in South El Monte end-to-end.
...
```
## Ready to Submit — South El Monte Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/south-el-monte/sign/`.
