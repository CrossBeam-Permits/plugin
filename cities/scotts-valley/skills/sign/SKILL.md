...
# Scotts Valley — Sign Permit

Handles sign permits in Scotts Valley end-to-end.
...
```
## Ready to Submit — Scotts Valley Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/scotts-valley/sign/`.
