...
# Scotts Valley — Pool Demolition Permit

Handles pool demolition permits in Scotts Valley end-to-end.
...
```
## Ready to Submit — Scotts Valley Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/scotts-valley/pool-demolition/`.
