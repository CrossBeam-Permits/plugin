...
# Redlands — Sign Permit

Handles sign permits in Redlands end-to-end.
...
```
## Ready to Submit — Redlands Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/redlands/sign/`.
