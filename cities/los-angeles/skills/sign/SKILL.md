...
# Los Angeles — Sign Permit

Handles sign permits in Los Angeles end-to-end.
...
```
## Ready to Submit — Los Angeles Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/los-angeles/sign/`.
