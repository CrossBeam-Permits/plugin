...
# Los Angeles — Pool Demolition Permit

Handles pool demolition permits in Los Angeles end-to-end.
...
```
## Ready to Submit — Los Angeles Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/los-angeles/pool-demolition/`.
