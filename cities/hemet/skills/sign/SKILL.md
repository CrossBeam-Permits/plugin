...
Handles sign permits in Hemet end-to-end.
...
```
## Ready to Submit — Hemet Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/hemet/sign/`.
