...
# Saint Helena — Pool Demolition Permit

Handles pool demolition permits in Saint Helena end-to-end.
...
```
## Ready to Submit — Saint Helena Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/saint-helena/pool-demolition/`.
