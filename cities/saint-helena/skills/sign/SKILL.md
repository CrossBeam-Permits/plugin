...
# Saint Helena — Sign Permit

Handles sign permits in Saint Helena end-to-end.
...
```
## Ready to Submit — Saint Helena Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/saint-helena/sign/`.
