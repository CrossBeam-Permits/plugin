...
Handles sign permits in Gardena end-to-end.
...
```
## Ready to Submit — Gardena Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/gardena/sign/`.
