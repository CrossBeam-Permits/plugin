...
# Sanger — Pool Demolition Permit

Handles pool demolition permits in Sanger end-to-end.
...
```
## Ready to Submit — Sanger Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/sanger/pool-demolition/`.
