...
Handles sign permits in Sanger end-to-end.
...
```
## Ready to Submit — Sanger Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/sanger/sign/`.
