...
# City of Amador City — Fireworks Temp Use Permit

Handles fireworks temp use permits in City of Amador City end-to-end.
...
```
## Ready to Submit — City of Amador City Fireworks Temp Use Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/fireworks-temp-use/`. City overlay source: `skills/cities/amador-city/fireworks-temp-use/`.
