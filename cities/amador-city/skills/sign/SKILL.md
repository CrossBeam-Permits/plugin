...
# City of Amador City — Sign Permit

Handles sign permits in City of Amador City end-to-end.
...
```
## Ready to Submit — City of Amador City Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/amador-city/sign/`.
