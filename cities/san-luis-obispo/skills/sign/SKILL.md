...
# San Luis Obispo — Sign Permit

Handles sign permits in San Luis Obispo end-to-end.
...
```
## Ready to Submit — San Luis Obispo Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/san-luis-obispo/sign/`.
