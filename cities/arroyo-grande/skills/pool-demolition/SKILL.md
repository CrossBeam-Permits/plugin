...
# Arroyo Grande — Pool Demolition Permit

Handles pool demolition permits in Arroyo Grande end-to-end.
...
```
## Ready to Submit — Arroyo Grande Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/arroyo-grande/pool-demolition/`.
