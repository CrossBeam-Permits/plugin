...
# Arroyo Grande — Sign Permit

Handles sign permits in Arroyo Grande end-to-end.
...
```
## Ready to Submit — Arroyo Grande Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/arroyo-grande/sign/`.
