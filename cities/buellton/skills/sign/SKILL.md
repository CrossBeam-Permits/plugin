...
# Buellton — Sign Permit

Handles sign permits in Buellton end-to-end.
...
```
## Ready to Submit — Buellton Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/buellton/sign/`.
