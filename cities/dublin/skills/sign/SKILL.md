...
Handles sign permits in Dublin end-to-end.
...
```
## Ready to Submit — Dublin Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/dublin/sign/`.
