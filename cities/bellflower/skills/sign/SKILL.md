...
# Bellflower — Sign Permit

Handles sign permits in Bellflower end-to-end.
...
```
## Ready to Submit — Bellflower Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/bellflower/sign/`.
