...
# Bellflower — Pool Demolition Permit

Handles pool demolition permits in Bellflower end-to-end.
...
```
## Ready to Submit — Bellflower Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/bellflower/pool-demolition/`.
