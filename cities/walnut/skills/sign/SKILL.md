...
Handles sign permits in Walnut end-to-end.
...
```
## Ready to Submit — Walnut Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/walnut/sign/`.
