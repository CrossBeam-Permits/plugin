...
# Lake Forest — Pool Demolition Permit

Handles pool demolition permits in Lake Forest end-to-end.
...
```
## Ready to Submit — Lake Forest Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/lake-forest/pool-demolition/`.
