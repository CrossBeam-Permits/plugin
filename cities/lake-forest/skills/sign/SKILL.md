...
# Lake Forest — Sign Permit

Handles sign permits in Lake Forest end-to-end.
...
```
## Ready to Submit — Lake Forest Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/lake-forest/sign/`.
