...
# Needles — Pool Demolition Permit

Handles pool demolition permits in Needles end-to-end.
...
```
## Ready to Submit — Needles Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/needles/pool-demolition/`.
