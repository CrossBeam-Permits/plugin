...
# San Mateo — Pool Demolition Permit

Handles pool demolition permits in San Mateo end-to-end.
...
```
## Ready to Submit — San Mateo Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/san-mateo/pool-demolition/`.
