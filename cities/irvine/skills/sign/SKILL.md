...
Handles sign permits in Irvine end-to-end.
...
```
## Ready to Submit — Irvine Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/irvine/sign/`.
