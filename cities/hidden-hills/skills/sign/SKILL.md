...
# Hidden Hills — Sign Permit

Handles sign permits in Hidden Hills end-to-end.
...
```
## Ready to Submit — Hidden Hills Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/hidden-hills/sign/`.
