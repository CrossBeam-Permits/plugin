...
# Hidden Hills — Rewire Permit

Handles rewire permits in Hidden Hills end-to-end.
...
```
## Ready to Submit — Hidden Hills Rewire Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/rewire/`. City overlay source: `skills/cities/hidden-hills/rewire/`.
