...
# Simi Valley — Pool Demolition Permit

Handles pool demolition permits in Simi Valley end-to-end.
...
```
## Ready to Submit — Simi Valley Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/simi-valley/pool-demolition/`.
