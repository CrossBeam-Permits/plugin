...
# Simi Valley — Sign Permit

Handles sign permits in Simi Valley end-to-end.
...
```
## Ready to Submit — Simi Valley Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/simi-valley/sign/`.
