...
# Hawthorne — Sign Permit

Handles sign permits in Hawthorne end-to-end.
...
```
## Ready to Submit — Hawthorne Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/hawthorne/sign/`.
