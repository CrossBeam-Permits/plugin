...
# Hawthorne — Cleanout Permit

Handles cleanout permits in Hawthorne end-to-end.
...
```
## Ready to Submit — Hawthorne Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/hawthorne/cleanout/`.
