...
# Milpitas — Sign Permit

Handles sign permits in Milpitas end-to-end.
...
```
## Ready to Submit — Milpitas Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/milpitas/sign/`.
