...
# Milpitas — Solar Permit

Handles solar permits in Milpitas end-to-end.
...
```
## Ready to Submit — Milpitas Solar Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/solar/`. City overlay source: `skills/cities/milpitas/solar/`.
