...
# San Carlos — Sign Permit

Handles sign permits in San Carlos end-to-end.
...
```
## Ready to Submit — San Carlos Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/san-carlos/sign/`.
