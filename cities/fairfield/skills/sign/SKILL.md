...
# Fairfield — Sign Permit

Handles sign permits in Fairfield end-to-end.
...
```
## Ready to Submit — Fairfield Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/fairfield/sign/`.
