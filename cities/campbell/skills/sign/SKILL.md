...
# Campbell — Sign Permit

Handles sign permits in Campbell end-to-end.
...
```
## Ready to Submit — Campbell Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/campbell/sign/`.
