...
# Fullerton — Sign Permit

Handles sign permits in Fullerton end-to-end.
...
- **1** Planning Division approval first — **flag**
- **2** DTSP — separate standards — **flag**
- **3** Illuminated sign — electrical permit — **flag**
- **4** Temporary sign permit — **flag**
- **5** Wind load design — **flag**
- **6** Seismic Design Category D — **flag**
- **7** FMC sign code specifics — **flag**
- **8** Fire agency — **flag**
- **9** Code cycle — **flag**
- **10** Portal — **flag**
...
```
## Ready to Submit — Fullerton Sign Permit
...
| 1 | **Planning Division approval first** `[FMC]` | ⚠️ **flag** | All permanent signs require Planning Division zoning/design review before Building permit is issued | FMC sign code |
| 2 | **DTSP — separate standards** `[FMC]` | ⚠️ **flag** | Signs in the Downtown Specific Plan area may have distinct standards (dimensions, materials, design review) beyond base commercial zone rules | DTSP |
| 3 | **Illuminated sign — electrical permit** `[FMC]` | ⚠️ **flag** | Separate electrical permit required under CEC 2025 for all illuminated signs; submit concurrently with building permit | CEC 2025 |
| 4 | **Temporary sign permit** `[FMC]` | ⚠️ **flag** | Banners, grand opening signs, and other temporary signs require a separate temporary sign permit — not covered under permanent sign permit | FMC sign code |
| 5 | **Wind load design** `[FMC]` | ⚠️ **flag** | Sign structure must be designed for Vult ≈ 95 mph, Wind Exposure C; verify exact design wind speed per ASCE 7 Hazard Tool for the specific parcel | 2025 CBC / ASCE 7-22 |
| 6 | **Seismic Design Category D** `[FMC]` | ⚠️ **flag** | Sign structures must meet SDC D requirements; structural calculations required for pole/monument signs and large wall signs | 2025 CBC |
| 7 | **FMC sign code specifics** `[FMC]` | ⚠️ **flag** | Full sign code text not retrieved — confirm zone-specific area limits, height limits, setbacks, illumination rules, and material standards with Planning Division | FMC (amlegal blocked) |
| 8 | **Fire agency** `[FMC]` | ⚠️ **flag** | Route fire/electrical sign review questions to Fullerton Fire Department — NOT OCFA | City of Fullerton |
| 9 | **Code cycle** `[FMC]` | ⚠️ **flag** | All plans submitted on/after 1/1/2026 must reference 2025 California Building Standards Code | 2025 CBC |
| 10 | **Portal** `[FMC]` | ⚠️ **flag** | All permit applications via getaPERMIT.net: https://www.getapermit.net/fullerton | City of Fullerton |

---

## References

Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/fullerton/sign/`.
