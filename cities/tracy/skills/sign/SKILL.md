...
Handles sign permits in Tracy end-to-end.
...
```
## Ready to Submit — Tracy Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/tracy/sign/`.
