...
# El Monte — Pool Demolition Permit

Handles pool demolition permits in El Monte end-to-end.
...
```
## Ready to Submit — El Monte Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/el-monte/pool-demolition/`.
