...
# El Monte — Sign Permit

Handles sign permits in El Monte end-to-end.
...
```
## Ready to Submit — El Monte Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/el-monte/sign/`.
