...
# Port Hueneme — Pool Demolition Permit

Handles pool demolition permits in Port Hueneme end-to-end.
...
```
## Ready to Submit — Port Hueneme Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/port-hueneme/pool-demolition/`.
