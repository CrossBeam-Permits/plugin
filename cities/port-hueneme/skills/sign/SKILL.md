...
# Port Hueneme — Sign Permit

Handles sign permits in Port Hueneme end-to-end.
...
```
## Ready to Submit — Port Hueneme Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/port-hueneme/sign/`.
