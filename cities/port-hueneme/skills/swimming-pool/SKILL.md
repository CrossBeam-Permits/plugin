...
# Port Hueneme — Swimming Pool Permit

Handles swimming pool permits in Port Hueneme end-to-end.
...
```
## Ready to Submit — Port Hueneme Swimming Pool Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/swimming-pool/`. City overlay source: `skills/cities/port-hueneme/swimming-pool/`.
