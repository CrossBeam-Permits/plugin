...
# American Canyon — Sign Permit

Handles sign permits in American Canyon end-to-end.
...
```
## Ready to Submit — American Canyon Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/american-canyon/sign/`.
