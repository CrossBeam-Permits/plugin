...
# American Canyon — Pool Demolition Permit

Handles pool demolition permits in American Canyon end-to-end.
...
```
## Ready to Submit — American Canyon Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/american-canyon/pool-demolition/`.
