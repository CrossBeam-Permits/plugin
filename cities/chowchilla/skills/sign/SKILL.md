...
# Chowchilla — Sign Permit

Handles sign permits in Chowchilla end-to-end.
...
```
## Ready to Submit — Chowchilla Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/chowchilla/sign/`.
