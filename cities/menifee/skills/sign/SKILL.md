...
Handles sign permits in Menifee end-to-end.
...
```
## Ready to Submit — Menifee Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/menifee/sign/`.
