...
# Gustine — Pool Demolition Permit

Handles pool demolition permits in Gustine end-to-end.
...
```
## Ready to Submit — Gustine Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/gustine/pool-demolition/`.
