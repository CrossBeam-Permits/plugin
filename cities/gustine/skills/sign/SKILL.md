...
Handles sign permits in Gustine end-to-end.
...
```
## Ready to Submit — Gustine Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/gustine/sign/`.
