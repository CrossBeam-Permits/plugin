...
# Marysville — Sign Permit

Handles sign permits in Marysville end-to-end.
...
```
## Ready to Submit — Marysville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/marysville/sign/`.
