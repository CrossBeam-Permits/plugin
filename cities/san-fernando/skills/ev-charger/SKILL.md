...
# San Fernando — Ev Charger Permit

Handles ev charger permits in San Fernando end-to-end.
...
```
## Ready to Submit — San Fernando Ev Charger Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ev-charger/`. City overlay source: `skills/cities/san-fernando/ev-charger/`.
