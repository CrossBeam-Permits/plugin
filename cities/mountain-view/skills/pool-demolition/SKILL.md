...
# Mountain View — Pool Demolition Permit

Handles pool demolition permits in Mountain View end-to-end.
...
```
## Ready to Submit — Mountain View Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/mountain-view/pool-demolition/`.
