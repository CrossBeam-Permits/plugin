...
# Mountain View — Sign Permit

Handles sign permits in Mountain View end-to-end.
...
```
## Ready to Submit — Mountain View Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/mountain-view/sign/`.
