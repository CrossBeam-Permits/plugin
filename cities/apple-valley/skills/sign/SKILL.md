...
# Apple Valley — Sign Permit

Handles sign permits in Apple Valley end-to-end.
...
```
## Ready to Submit — Apple Valley Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/apple-valley/sign/`.
