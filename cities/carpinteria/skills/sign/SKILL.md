...
# Carpinteria — Sign Permit

Handles sign permits in Carpinteria end-to-end.
...
```
## Ready to Submit — Carpinteria Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/carpinteria/sign/`.
