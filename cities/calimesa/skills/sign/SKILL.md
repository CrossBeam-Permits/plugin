...
# Calimesa — Sign Permit

Handles sign permits in Calimesa end-to-end.
...
```
## Ready to Submit — Calimesa Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/calimesa/sign/`.
