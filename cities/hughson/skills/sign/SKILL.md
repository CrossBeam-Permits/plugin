...
Handles sign permits in Hughson end-to-end.
...
```
## Ready to Submit — Hughson Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/hughson/sign/`.
