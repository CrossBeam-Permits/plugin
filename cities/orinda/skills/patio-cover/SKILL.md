...
# Orinda — Patio Cover Permit

Handles patio cover permits in Orinda end-to-end.
...
```
## Ready to Submit — Orinda Patio Cover Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/patio-cover/`. City overlay source: `skills/cities/orinda/patio-cover/`.
