...
# San Leandro — Cleanout Permit

Handles cleanout permits in San Leandro end-to-end.
...
```
## Ready to Submit — San Leandro Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/san-leandro/cleanout/`.
