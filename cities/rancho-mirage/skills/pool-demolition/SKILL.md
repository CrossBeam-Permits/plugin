...
# Rancho Mirage — Pool Demolition Permit

Handles pool demolition permits in Rancho Mirage end-to-end.
...
```
## Ready to Submit — Rancho Mirage Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/rancho-mirage/pool-demolition/`.
