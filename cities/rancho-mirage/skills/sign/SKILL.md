...
# Rancho Mirage — Sign Permit

Handles sign permits in Rancho Mirage end-to-end.
...
```
## Ready to Submit — Rancho Mirage Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/rancho-mirage/sign/`.
