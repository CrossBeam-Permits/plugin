...
# Corcoran — Sign Permit

Handles sign permits in Corcoran end-to-end.
...
```
## Ready to Submit — Corcoran Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/corcoran/sign/`.
