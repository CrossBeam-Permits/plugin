...
Handles sign permits in Lincoln end-to-end.
...
```
## Ready to Submit — Lincoln Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/lincoln/sign/`.
