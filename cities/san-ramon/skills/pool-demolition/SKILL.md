...
# San Ramon — Pool Demolition Permit

Handles pool demolition permits in San Ramon end-to-end.
...
```
## Ready to Submit — San Ramon Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/san-ramon/pool-demolition/`.
