...
# San Rafael — Pool Demolition Permit

Handles pool demolition permits in San Rafael end-to-end.
...
```
## Ready to Submit — San Rafael Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/san-rafael/pool-demolition/`.
