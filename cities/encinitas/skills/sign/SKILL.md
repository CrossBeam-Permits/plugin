...
# Encinitas — Sign Permit

Handles sign permits in Encinitas end-to-end.
...
```
## Ready to Submit — Encinitas Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/encinitas/sign/`.
