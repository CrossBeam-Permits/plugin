...
# Encinitas — Pool Demolition Permit

Handles pool demolition permits in Encinitas end-to-end.
...
```
## Ready to Submit — Encinitas Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/encinitas/pool-demolition/`.
