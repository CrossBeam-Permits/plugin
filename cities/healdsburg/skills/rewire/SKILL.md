...
# Healdsburg — Rewire Permit

Handles rewire permits in Healdsburg end-to-end.
...
```
## Ready to Submit — Healdsburg Rewire Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/rewire/`. City overlay source: `skills/cities/healdsburg/rewire/`.
