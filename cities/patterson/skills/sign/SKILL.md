...
# Patterson — Sign Permit

Handles sign permits in Patterson end-to-end.
...
```
## Ready to Submit — Patterson Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/patterson/sign/`.
