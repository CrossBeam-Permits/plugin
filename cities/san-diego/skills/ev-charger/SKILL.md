...
# San Diego — Ev Charger Permit

Handles ev charger permits in San Diego end-to-end.
...
```
## Ready to Submit — San Diego Ev Charger Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ev-charger/`. City overlay source: `skills/cities/san-diego/ev-charger/`.
