...
# San Diego — Sign Permit

Handles sign permits in San Diego end-to-end.
...
```
## Ready to Submit — San Diego Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/san-diego/sign/`.
