...
# Lake Elsinore — Sign Permit

Handles sign permits in Lake Elsinore end-to-end.
...
```
## Ready to Submit — Lake Elsinore Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/lake-elsinore/sign/`.
