...
# Mammoth Lakes — Pool Demolition Permit

Handles pool demolition permits in Mammoth Lakes end-to-end.
...
```
## Ready to Submit — Mammoth Lakes Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/mammoth-lakes/pool-demolition/`.
