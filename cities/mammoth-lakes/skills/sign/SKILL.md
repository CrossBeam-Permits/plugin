...
# Mammoth Lakes — Sign Permit

Handles sign permits in Mammoth Lakes end-to-end.
...
```
## Ready to Submit — Mammoth Lakes Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/mammoth-lakes/sign/`.
