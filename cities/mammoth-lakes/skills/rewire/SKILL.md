...
# Mammoth Lakes — Rewire Permit

Handles rewire permits in Mammoth Lakes end-to-end.
...
```
## Ready to Submit — Mammoth Lakes Rewire Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/rewire/`. City overlay source: `skills/cities/mammoth-lakes/rewire/`.
