...
Handles sign permits in Madera end-to-end.
...
```
## Ready to Submit — Madera Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/madera/sign/`.
