...
# Vacaville — Sign Permit

Handles sign permits in Vacaville end-to-end.
...
```
## Ready to Submit — Vacaville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/vacaville/sign/`.
