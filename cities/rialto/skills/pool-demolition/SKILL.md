...
# Rialto — Pool Demolition Permit

Handles pool demolition permits in Rialto end-to-end.
...
```
## Ready to Submit — Rialto Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/rialto/pool-demolition/`.
