...
# La Mesa — Pool Demolition Permit

Handles pool demolition permits in La Mesa end-to-end.
...
```
## Ready to Submit — La Mesa Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/la-mesa/pool-demolition/`.
