...
# Brisbane — Ltia Demolition Permit

Handles ltia demolition permits in Brisbane end-to-end.
...
```
## Ready to Submit — Brisbane Ltia Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ltia-demolition/`. City overlay source: `skills/cities/brisbane/ltia-demolition/`.
