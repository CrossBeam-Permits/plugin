...
# La Mirada — Sign Permit

Handles sign permits in La Mirada end-to-end.
...
```
## Ready to Submit — La Mirada Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/la-mirada/sign/`.
