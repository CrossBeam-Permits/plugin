...
# La Mirada — Rewire Permit

Handles rewire permits in La Mirada end-to-end.
...
```
## Ready to Submit — La Mirada Rewire Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/rewire/`. City overlay source: `skills/cities/la-mirada/rewire/`.
