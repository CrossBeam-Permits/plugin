...
# La Mirada — Pool Demolition Permit

Handles pool demolition permits in La Mirada end-to-end.
...
```
## Ready to Submit — La Mirada Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/la-mirada/pool-demolition/`.
