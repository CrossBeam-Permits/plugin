...
# Stockton — Hvac Permit

Handles hvac permits in Stockton end-to-end.
...
```
## Ready to Submit — Stockton Hvac Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/hvac/`. City overlay source: `skills/cities/stockton/hvac/`.
