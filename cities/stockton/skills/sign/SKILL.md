...
# Stockton — Sign Permit

Handles sign permits in Stockton end-to-end.
...
```
## Ready to Submit — Stockton Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/stockton/sign/`.
