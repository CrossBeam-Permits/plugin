...
Handles sign permits in Corning end-to-end.
...
```
## Ready to Submit — Corning Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/corning/sign/`.
