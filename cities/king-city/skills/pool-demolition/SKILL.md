...
# King City — Pool Demolition Permit

Handles pool demolition permits in King City end-to-end.
...
```
## Ready to Submit — King City Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/king-city/pool-demolition/`.
