...
# South Lake Tahoe — Sign Permit

Handles sign permits in South Lake Tahoe end-to-end.
...
```
## Ready to Submit — South Lake Tahoe Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/south-lake-tahoe/sign/`.
