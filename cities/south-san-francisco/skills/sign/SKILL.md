...
# South San Francisco — Sign Permit

Handles sign permits in South San Francisco end-to-end.
...
```
## Ready to Submit — South San Francisco Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/south-san-francisco/sign/`.
