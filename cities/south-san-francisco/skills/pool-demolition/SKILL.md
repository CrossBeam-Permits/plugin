---
description: "Pool Demolition permits in South San Francisco, CA. Works in two modes: (A) BUILDER/HOMEOWNER — walks through project scoping, checks compliance against state code + South San Francisco local amendments, produces an Accela-ready submission guide; (B) CITY REVIEWER — runs the plan-check checklist against a submittal and produces tight corrections output. Inspection items deferred (not listed as corrections). Use when the user mentions pool demolition in South San Francisco."
version: "1.0"
...
# South San Francisco — Pool Demolition Permit

Handles pool demolition permits in South San Francisco end-to-end.
...
```
## Ready to Submit — South San Francisco Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/south-san-francisco/pool-demolition/`.
