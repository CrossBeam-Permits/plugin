...
Handles sign permits in Folsom end-to-end.
...
```
## Ready to Submit — Folsom Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/folsom/sign/`.
