...
# City of Shasta Lake — Pool Demolition Permit

Handles pool demolition permits in City of Shasta Lake end-to-end.
...
```
## Ready to Submit — City of Shasta Lake Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/shasta-lake/pool-demolition/`.
