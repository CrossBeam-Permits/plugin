...
# Santa Rosa — Pool Demolition Permit

Handles pool demolition permits in Santa Rosa end-to-end.
...
```
## Ready to Submit — Santa Rosa Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/santa-rosa/pool-demolition/`.
