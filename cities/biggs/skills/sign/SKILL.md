...
Handles sign permits in Biggs end-to-end.
...
```
## Ready to Submit — Biggs Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/biggs/sign/`.
