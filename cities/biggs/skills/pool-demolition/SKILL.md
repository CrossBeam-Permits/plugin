...
# Biggs — Pool Demolition Permit

Handles pool demolition permits in Biggs end-to-end.
...
```
## Ready to Submit — Biggs Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/biggs/pool-demolition/`.
