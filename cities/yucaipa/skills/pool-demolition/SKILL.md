...
# Yucaipa — Pool Demolition Permit

Handles pool demolition permits in Yucaipa end-to-end.
...
- **1** Pool Abandonment Handout — Review Required — **flag**
- **2** Perforation for Drainage — **flag**
- **3** Compacted Clean Fill — Lift Requirement — **flag**
- **4** Soils Report Trigger — **flag**
- **5** Electrical Equipment Disconnection — **flag**
- **6** Site Plan Showing Before and After — **flag**
- **7** SDC D — Seismic Consideration — **flag**
- **8** Future Use Disclosure — **flag**
...
```
## Ready to Submit — Yucaipa Pool Demolition Permit
...
| 1 | **Pool Abandonment Handout — Review Required** `[YMC]` | ⚠️ **flag** | Applicant must obtain and review Yucaipa's dedicated handout PDF (07-pool-abandonment.pdf) before submittal. The handout specifies the exact abandonment process the city expects. Contact Building & Safety at (909) 797-2489 to obtain the current version. | yucaipa.gov/building-safety/ |
| 2 | **Perforation for Drainage** `[YMC]` | ⚠️ **flag** | Pool bottom and sides must be perforated with holes to allow drainage of any groundwater or infiltration. Perforation method and spacing should be shown on the submitted site plan or detail sheet. | 07-pool-abandonment.pdf |
| 3 | **Compacted Clean Fill — Lift Requirement** `[YMC]` | ⚠️ **flag** | Fill must be compacted clean material (gravel base + clean fill) placed in lifts per the handout requirements. Uncompacted fill or debris fill is not acceptable. A compaction report (or soils report) may be required by the Building Official for larger pools. | 07-pool-abandonment.pdf |
| 4 | **Soils Report Trigger** `[YMC]` | ⚠️ **flag** | For pools with significant fill volume, the Building Official may require a soils engineer's report confirming adequate compaction and site stability. Coordinate with Building & Safety at pre-submittal if pool volume is large or if site conditions are unusual. | 07-pool-abandonment.pdf; CBC |
| 5 | **Electrical Equipment Disconnection** `[YMC]` | ⚠️ **flag** | All pool-related electrical equipment (pump, heater, lights, automated controllers) must be disconnected and removed or properly abandoned. Pool bonding system must also be addressed. Include electrical disconnection details or letter from licensed electrician in the submittal package. | CBC 3303.6; CEC Article 680 |
| 6 | **Site Plan Showing Before and After** `[YMC]` | ⚠️ **flag** | Submit a site plan showing the existing pool location, surrounding structures, setbacks, and the proposed abandonment/fill condition. A "before and after" diagram is expected per city practice. | 07-pool-abandonment.pdf |
| 7 | **SDC D — Seismic Consideration** `[YMC]` | ⚠️ **flag** | Yucaipa is in Seismic Design Category D. For large pool abandonments where the area will be used for future construction or significant loading, engineering review of fill compaction is especially important to prevent differential settlement. | CBC Ch. 16 |
| 8 | **Future Use Disclosure** `[YMC]` | ⚠️ **flag** | If the applicant intends to use the abandoned pool area for any future structure (patio, garage, addition), disclose this upfront. Standard abandonment fill may not support structural loads — an engineered fill specification would be required. | CBC; CITY.md |
| 9 | **Submit via EnerGov Portal or OTC Wednesday** `[YMC]` | ⚠️ **flag** | Use Tyler EnerGov "Yucaipa Permit Exchange" portal for online submittal. Over-the-counter intake is available Wednesdays 1:00–4:30 PM only. | CITY.md |
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/yucaipa/pool-demolition/`.
