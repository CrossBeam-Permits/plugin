...
# Yucaipa — Cleanout Permit

Handles cleanout permits in Yucaipa end-to-end.
...
```
## Ready to Submit — Yucaipa Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/yucaipa/cleanout/`.
