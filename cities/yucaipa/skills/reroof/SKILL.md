---
description: "Reroof permits in Yucaipa, CA. Works in two modes: (A) BUILDER/HOMEOWNER — walks through project scoping, checks compliance against state code + Yucaipa local amendments, produces an Accela-ready submission guide; (B) CITY REVIEWER — runs the plan-check checklist against a submittal and produces tight corrections output. Inspection items deferred (not listed as corrections). Use when the user mentions reroof in Yucaipa."
version: "1.0"
...
# Yucaipa — Reroof Permit

Handles reroof permits in Yucaipa end-to-end.
...
- **1** Class A Fire Rating — All Reroofs — **flag**
- **2** FHSZ Parcel Check — CRITICAL — **flag**
- **3** FHSZ Very High — Ember-Resistant Underlayment — **flag**
- **5** Sheathing Replacement — Additional Plan Check — **flag**
- **6** Solar System Coordination — **flag**
- **7** Fire Marshal Coordination — FHSZ — **flag**
- **8** 2025 OSFM Map Update — **flag**
...
```
## Ready to Submit — Yucaipa Reroof Permit
...
| 1 | **Class A Fire Rating — All Reroofs** `[YMC]` | ⚠️ **flag** | All reroofs in California (and Yucaipa) must use a **Class A fire-rated roofing assembly**. Class B or C products are not acceptable on any structure. Verify the roofing product's UL/ICC listing as Class A in the submittal. | 2022 CBC |
| 2 | **FHSZ Parcel Check — CRITICAL** `[YMC]` | ⚠️ **flag** | North, northeast, and east hillside/canyon areas of Yucaipa are in High or Very High FHSZ (LRA). If the reroof parcel is in High or Very High FHSZ, CBC **Chapter 7A** fire-resistance requirements apply — standard Class A shingles alone are NOT sufficient. Chapter 7A requires: (a) Class A fire-rated roof assembly, (b) ember-resistant underlayment, (c) ember-resistant vents (ASTM E2886), (d) the entire roof system (decking, underlayment, finish material) must comply as a system. | CBC Ch. 7A; MC §15.04.115 |
| 3 | **FHSZ Very High — Ember-Resistant Underlayment** `[YMC]` | ⚠️ **flag** | For Very High FHSZ parcels, standard felt underlayment is NOT acceptable under Chapter 7A. The underlayment must be an ember-resistant product meeting the CBC Chapter 7A requirements. Product listing and installation details must be shown on the submittal. | CBC Ch. 7A §705A |
| 5 | **Sheathing Replacement — Additional Plan Check** `[YMC]` | ⚠️ **flag** | If roof sheathing (plywood or OSB decking) requires replacement during the reroof, this may trigger additional plan check review beyond a standard OTC reroof permit. Notify Building & Safety at pre-submittal if sheathing replacement is expected; additional structural review or structural calculations (SDC D) may be required. | CBC; SDC D |
| 6 | **Solar System Coordination** `[YMC]` | ⚠️ **flag** | If the property has an existing permitted solar system, the solar panels must be removed and reinstalled as part of the reroof. A separate solar permit pull (or notation on the reroof permit) may be required to document the re-installation. Confirm the requirement with Building & Safety — failure to address existing solar may result in inspection failure or a correction. | City practice; CBC |
| 7 | **Fire Marshal Coordination — FHSZ** `[YMC]` | ⚠️ **flag** | For FHSZ reroof projects, coordinate fire plan review with Fire Marshal Craig Sanchez (csanchez@yucaipa.org, Ext. 246). Fire may require review of the full roof assembly specification for Chapter 7A compliance before permit issuance. | CITY.md |
| 8 | **2025 OSFM Map Update** `[YMC]` | ⚠️ **flag** | Updated OSFM LRA maps have a local adoption deadline of July 22, 2025. As of 2026-04-15, confirm with Yucaipa whether the 2025 updated FHSZ maps are in effect — expanded FHSZ boundaries may affect previously non-FHSZ parcels. | OSFM; MC §15.04.115 |
| 9 | **Submit via EnerGov Portal or OTC Wednesday** `[YMC]` | ⚠️ **flag** | Standard reroof on non-FHSZ property is typically handled OTC. Use Tyler EnerGov "Yucaipa Permit Exchange" portal for online submittal, or OTC Wednesday 1:00–4:30 PM. | CITY.md |
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/reroof/`. City overlay source: `skills/cities/yucaipa/reroof/`.
