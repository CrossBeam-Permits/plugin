...
# City of Montague — Pool Demolition Permit

Handles pool demolition permits in City of Montague end-to-end.
...
```
## Ready to Submit — City of Montague Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/montague/pool-demolition/`.
