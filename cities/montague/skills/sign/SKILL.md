...
# City of Montague — Sign Permit

Handles sign permits in City of Montague end-to-end.
...
```
## Ready to Submit — City of Montague Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/montague/sign/`.
