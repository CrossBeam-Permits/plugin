...
Handles sign permits in Brea end-to-end.
...
- **2** Temporary sign permit — **flag**
- **3** Residential freestanding sign setback — **flag**
- **4** Residential sign limit — **flag**
- **5** Chapter 20.28 specifics — **flag**
- **6** Fire authority — **flag**
- **7** Code cycle — **flag**
- **8** Portal — **flag**
...
```
## Ready to Submit — Brea Sign Permit
...
| 1 | **Planning Division approval first** `[BMC]` | ⚠️ **flag** | All signs require Planning Division review for zoning compliance before Building permit | BMC Chapter 20.28 |
| 2 | **Temporary sign permit** `[BMC]` | ⚠️ **flag** | Grand openings, banners, and other temporary signs require a separate temporary sign permit — not covered under the permanent sign permit | BMC Chapter 20.28 |
| 3 | **Residential freestanding sign setback** `[BMC]` | ⚠️ **flag** | Freestanding sign for apartment identification: minimum 15 ft from curb face; must be in landscaped area ≥ half the sign area | BMC Chapter 20.28 |
| 4 | **Residential sign limit** `[BMC]` | ⚠️ **flag** | R-2/R-3 parcels: maximum one wall sign AND one freestanding sign per parcel for apartment identification | BMC Chapter 20.28 |
| 5 | **Chapter 20.28 specifics** `[BMC]` | ⚠️ **flag** | Full sign code text not retrieved — always contact Planning for allowable area, height, setbacks, illumination for specific zone | BMC Chapter 20.28 |
| 6 | **Fire authority** `[BMC]` | ⚠️ **flag** | Brea Fire Department (NOT OCFA) for any fire/electrical sign review questions | City of Brea |
| 7 | **Code cycle** `[BMC]` | ⚠️ **flag** | Plans submitted on or after 1/1/2026 must cite 2025 Edition of California Building Standards Code | 2025 CBC |
| 8 | **Portal** `[BMC]` | ⚠️ **flag** | All permits submitted via Accela: https://aca-prod.accela.com/BREA/CommunityView | City of Brea |

---

## References

Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/brea/sign/`.
