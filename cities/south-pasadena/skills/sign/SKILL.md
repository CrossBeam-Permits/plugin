...
# South Pasadena — Sign Permit

Handles sign permits in South Pasadena end-to-end.
...
```
## Ready to Submit — South Pasadena Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/south-pasadena/sign/`.
