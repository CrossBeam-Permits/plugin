...
# Laguna Woods — Pool Demolition Permit

Handles pool demolition permits in Laguna Woods end-to-end.
...
```
## Ready to Submit — Laguna Woods Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/laguna-woods/pool-demolition/`.
