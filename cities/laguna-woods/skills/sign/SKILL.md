...
# Laguna Woods — Sign Permit

Handles sign permits in Laguna Woods end-to-end.
...
```
## Ready to Submit — Laguna Woods Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/laguna-woods/sign/`.
