...
# Chula Vista — Sign Permit

Handles sign permits in Chula Vista end-to-end.
...
```
## Ready to Submit — Chula Vista Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/chula-vista/sign/`.
