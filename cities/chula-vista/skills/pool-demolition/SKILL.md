...
# Chula Vista — Pool Demolition Permit

Handles pool demolition permits in Chula Vista end-to-end.
...
```
## Ready to Submit — Chula Vista Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/chula-vista/pool-demolition/`.
