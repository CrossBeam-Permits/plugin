...
# Calabasas — Sign Permit

Handles sign permits in Calabasas end-to-end.
...
```
## Ready to Submit — Calabasas Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/calabasas/sign/`.
