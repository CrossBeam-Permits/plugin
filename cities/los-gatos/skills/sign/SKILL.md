...
# Los Gatos — Sign Permit

Handles sign permits in Los Gatos end-to-end.
...
```
## Ready to Submit — Los Gatos Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/los-gatos/sign/`.
