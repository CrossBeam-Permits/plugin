...
# Del Rey Oaks — Pool Demolition Permit

Handles pool demolition permits in Del Rey Oaks end-to-end.
...
```
## Ready to Submit — Del Rey Oaks Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/del-rey-oaks/pool-demolition/`.
