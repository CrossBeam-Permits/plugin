...
# Coronado — Sign Permit

Handles sign permits in Coronado end-to-end.
...
```
## Ready to Submit — Coronado Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/coronado/sign/`.
