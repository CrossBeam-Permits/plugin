...
# Rosemead — Sign Permit

Handles sign permits in Rosemead end-to-end.
...
```
## Ready to Submit — Rosemead Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/rosemead/sign/`.
