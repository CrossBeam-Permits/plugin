...
# Rosemead — Rewire Permit

Handles rewire permits in Rosemead end-to-end.
...
```
## Ready to Submit — Rosemead Rewire Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/rewire/`. City overlay source: `skills/cities/rosemead/rewire/`.
