...
# Rosemead — Pool Demolition Permit

Handles pool demolition permits in Rosemead end-to-end.
...
```
## Ready to Submit — Rosemead Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/rosemead/pool-demolition/`.
