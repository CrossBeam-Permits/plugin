...
# Elk Grove — Sign Permit

Handles sign permits in Elk Grove end-to-end.
...
```
## Ready to Submit — Elk Grove Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/elk-grove/sign/`.
