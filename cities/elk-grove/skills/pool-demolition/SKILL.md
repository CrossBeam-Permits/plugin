...
# Elk Grove — Pool Demolition Permit

Handles pool demolition permits in Elk Grove end-to-end.
...
```
## Ready to Submit — Elk Grove Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/elk-grove/pool-demolition/`.
