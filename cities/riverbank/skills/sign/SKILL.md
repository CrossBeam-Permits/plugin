...
# Riverbank — Sign Permit

Handles sign permits in Riverbank end-to-end.
...
```
## Ready to Submit — Riverbank Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/riverbank/sign/`.
