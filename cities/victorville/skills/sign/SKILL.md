...
# Victorville — Sign Permit

Handles sign permits in Victorville end-to-end.
...
```
## Ready to Submit — Victorville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/victorville/sign/`.
