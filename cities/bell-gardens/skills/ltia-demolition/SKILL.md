...
# Bell Gardens — Ltia Demolition Permit

Handles ltia demolition permits in Bell Gardens end-to-end.
...
```
## Ready to Submit — Bell Gardens Ltia Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ltia-demolition/`. City overlay source: `skills/cities/bell-gardens/ltia-demolition/`.
