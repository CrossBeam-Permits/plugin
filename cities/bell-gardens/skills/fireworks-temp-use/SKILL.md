...
# Bell Gardens — Fireworks Temp Use Permit

Handles fireworks temp use permits in Bell Gardens end-to-end.
...
```
## Ready to Submit — Bell Gardens Fireworks Temp Use Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/fireworks-temp-use/`. City overlay source: `skills/cities/bell-gardens/fireworks-temp-use/`.
