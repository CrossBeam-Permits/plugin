...
# Bell Gardens — Sign Permit

Handles sign permits in Bell Gardens end-to-end.
...
```
## Ready to Submit — Bell Gardens Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/bell-gardens/sign/`.
