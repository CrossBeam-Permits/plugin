...
# Bell Gardens — Pool Demolition Permit

Handles pool demolition permits in Bell Gardens end-to-end.
...
```
## Ready to Submit — Bell Gardens Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/bell-gardens/pool-demolition/`.
