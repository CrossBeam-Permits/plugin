...
# Bell Gardens — Cleanout Permit

Handles cleanout permits in Bell Gardens end-to-end.
...
```
## Ready to Submit — Bell Gardens Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/bell-gardens/cleanout/`.
