...
# Bell Gardens — Patio Cover Permit

Handles patio cover permits in Bell Gardens end-to-end.
...
```
## Ready to Submit — Bell Gardens Patio Cover Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/patio-cover/`. City overlay source: `skills/cities/bell-gardens/patio-cover/`.
