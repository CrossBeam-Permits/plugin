...
# Bell Gardens — Swimming Pool Permit

Handles swimming pool permits in Bell Gardens end-to-end.
...
```
## Ready to Submit — Bell Gardens Swimming Pool Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/swimming-pool/`. City overlay source: `skills/cities/bell-gardens/swimming-pool/`.
