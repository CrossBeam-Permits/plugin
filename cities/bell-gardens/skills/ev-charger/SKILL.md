...
# Bell Gardens — Ev Charger Permit

Handles ev charger permits in Bell Gardens end-to-end.
...
```
## Ready to Submit — Bell Gardens Ev Charger Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/ev-charger/`. City overlay source: `skills/cities/bell-gardens/ev-charger/`.
