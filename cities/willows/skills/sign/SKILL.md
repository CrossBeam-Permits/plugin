...
Handles sign permits in Willows end-to-end.
...
```
## Ready to Submit — Willows Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/willows/sign/`.
