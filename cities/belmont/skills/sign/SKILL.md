...
Handles sign permits in Belmont end-to-end.
...
```
## Ready to Submit — Belmont Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/belmont/sign/`.
