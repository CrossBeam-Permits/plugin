...
Handles sign permits in Galt end-to-end.
...
```
## Ready to Submit — Galt Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/galt/sign/`.
