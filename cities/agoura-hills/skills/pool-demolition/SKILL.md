...
# Agoura Hills — Pool Demolition Permit

Handles pool demolition permits in Agoura Hills end-to-end.
...
```
## Ready to Submit — Agoura Hills Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/agoura-hills/pool-demolition/`.
