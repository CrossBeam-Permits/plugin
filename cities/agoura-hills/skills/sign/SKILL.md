...
# Agoura Hills — Sign Permit

Handles sign permits in Agoura Hills end-to-end.
...
```
## Ready to Submit — Agoura Hills Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/agoura-hills/sign/`.
