...
# Holtville — Sign Permit

Handles sign permits in Holtville end-to-end.
...
```
## Ready to Submit — Holtville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/holtville/sign/`.
