...
# Marina — Pool Demolition Permit

Handles pool demolition permits in Marina end-to-end.
...
```
## Ready to Submit — Marina Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/marina/pool-demolition/`.
