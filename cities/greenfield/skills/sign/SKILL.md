...
# Greenfield — Sign Permit

Handles sign permits in Greenfield end-to-end.
...
```
## Ready to Submit — Greenfield Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/greenfield/sign/`.
