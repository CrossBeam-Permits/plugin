...
# Greenfield — Pool Demolition Permit

Handles pool demolition permits in Greenfield end-to-end.
...
```
## Ready to Submit — Greenfield Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/greenfield/pool-demolition/`.
