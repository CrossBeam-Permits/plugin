...
Handles sign permits in Ross end-to-end.
...
```
## Ready to Submit — Ross Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/ross/sign/`.
