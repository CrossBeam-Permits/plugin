...
# Sebastopol — Sign Permit

Handles sign permits in Sebastopol end-to-end.
...
```
## Ready to Submit — Sebastopol Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/sebastopol/sign/`.
