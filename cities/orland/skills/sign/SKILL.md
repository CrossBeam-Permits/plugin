...
Handles sign permits in Orland end-to-end.
...
```
## Ready to Submit — Orland Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/orland/sign/`.
