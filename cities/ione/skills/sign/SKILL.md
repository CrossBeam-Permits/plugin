...
Handles sign permits in Ione end-to-end.
...
```
## Ready to Submit — Ione Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/ione/sign/`.
