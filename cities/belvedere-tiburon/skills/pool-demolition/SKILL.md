...
# Belvedere/Tiburon — Pool Demolition Permit

Handles pool demolition permits in Belvedere/Tiburon end-to-end.
...
```
## Ready to Submit — Belvedere/Tiburon Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/belvedere-tiburon/pool-demolition/`.
