...
# Belvedere/Tiburon — Solar Permit

Handles solar permits in Belvedere/Tiburon end-to-end.
...
```
## Ready to Submit — Belvedere/Tiburon Solar Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/solar/`. City overlay source: `skills/cities/belvedere-tiburon/solar/`.
