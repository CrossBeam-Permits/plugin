...
# Davis — Cleanout Permit

Handles cleanout permits in Davis end-to-end.
...
```
## Ready to Submit — Davis Cleanout Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/cleanout/`. City overlay source: `skills/cities/davis/cleanout/`.
