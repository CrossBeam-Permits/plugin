...
# Sausalito — Solar Permit

Handles solar permits in Sausalito end-to-end.
...
```
## Ready to Submit — Sausalito Solar Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/solar/`. City overlay source: `skills/cities/sausalito/solar/`.
