...
# Sausalito — Sign Permit

Handles sign permits in Sausalito end-to-end.
...
```
## Ready to Submit — Sausalito Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/sausalito/sign/`.
