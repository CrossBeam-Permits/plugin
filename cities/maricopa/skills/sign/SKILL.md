...
# Maricopa — Sign Permit

Handles sign permits in Maricopa end-to-end.
...
```
## Ready to Submit — Maricopa Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/maricopa/sign/`.
