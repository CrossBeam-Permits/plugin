...
# Cerritos — Rewire Permit

Handles rewire permits in Cerritos end-to-end.
...
```
## Ready to Submit — Cerritos Rewire Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/rewire/`. City overlay source: `skills/cities/cerritos/rewire/`.
