...
# Cerritos — Sign Permit

Handles sign permits in Cerritos end-to-end.
...
```
## Ready to Submit — Cerritos Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/cerritos/sign/`.
