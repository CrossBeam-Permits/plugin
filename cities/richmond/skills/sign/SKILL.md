...
# Richmond — Sign Permit

Handles sign permits in Richmond end-to-end.
...
```
## Ready to Submit — Richmond Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/richmond/sign/`.
