...
# Santa Monica — Pool Demolition Permit

Handles pool demolition permits in Santa Monica end-to-end.
...
```
## Ready to Submit — Santa Monica Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/santa-monica/pool-demolition/`.
