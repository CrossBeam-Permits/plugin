...
# Santa Monica — Sign Permit

Handles sign permits in Santa Monica end-to-end.
...
```
## Ready to Submit — Santa Monica Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/santa-monica/sign/`.
