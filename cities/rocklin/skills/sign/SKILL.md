...
Handles sign permits in Rocklin end-to-end.
...
```
## Ready to Submit — Rocklin Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/rocklin/sign/`.
