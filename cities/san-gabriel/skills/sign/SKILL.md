...
# San Gabriel — Sign Permit

Handles sign permits in San Gabriel end-to-end.
...
```
## Ready to Submit — San Gabriel Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/san-gabriel/sign/`.
