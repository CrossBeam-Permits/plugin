...
# San Gabriel — Pool Demolition Permit

Handles pool demolition permits in San Gabriel end-to-end.
...
```
## Ready to Submit — San Gabriel Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/san-gabriel/pool-demolition/`.
