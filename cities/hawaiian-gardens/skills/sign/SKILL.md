...
# Hawaiian Gardens — Sign Permit

Handles sign permits in Hawaiian Gardens end-to-end.
...
```
## Ready to Submit — Hawaiian Gardens Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/hawaiian-gardens/sign/`.
