...
# Hawaiian Gardens — Pool Demolition Permit

Handles pool demolition permits in Hawaiian Gardens end-to-end.
...
```
## Ready to Submit — Hawaiian Gardens Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/hawaiian-gardens/pool-demolition/`.
