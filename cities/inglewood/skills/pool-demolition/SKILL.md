...
# Inglewood — Pool Demolition Permit

Handles pool demolition permits in Inglewood end-to-end.
...
```
## Ready to Submit — Inglewood Pool Demolition Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/pool-demolition/`. City overlay source: `skills/cities/inglewood/pool-demolition/`.
