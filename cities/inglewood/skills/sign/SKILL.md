...
# Inglewood — Sign Permit

Handles sign permits in Inglewood end-to-end.
...
```
## Ready to Submit — Inglewood Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/inglewood/sign/`.
