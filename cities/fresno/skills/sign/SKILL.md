...
Handles sign permits in Fresno end-to-end.
...
```
## Ready to Submit — Fresno Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/fresno/sign/`.
