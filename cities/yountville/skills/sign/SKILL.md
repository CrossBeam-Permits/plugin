...
# Yountville — Sign Permit

Handles sign permits in Yountville end-to-end.
...
```
## Ready to Submit — Yountville Sign Permit
...
Deep-dive references are in `references/` — load on demand for specific code questions. State skill source: `skills/california/sign/`. City overlay source: `skills/cities/yountville/sign/`.
